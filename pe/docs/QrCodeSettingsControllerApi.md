...
QrCodeSettings client.get_merged_mobile_app_settings()  # Get QR code configuration for home page (getMergedMobileAppSettings)
...
QrCodeSettings client.save_qr_code_settings(qr_code_settings: QrCodeSettings)  # Create Or Update the Mobile application settings (saveQrCodeSettings)
```
...
## get_merged_mobile_app_settings

```python
QrCodeSettings client.get_merged_mobile_app_settings()
```
