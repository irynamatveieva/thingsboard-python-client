...
bytearray client.download_login_favicon(type: str, key: str, if_none_match: Optional[str] = None, accept_encoding: Optional[str] = None)  # downloadLoginFavicon
bytearray client.download_login_logo(type: str, key: str, if_none_match: Optional[str] = None, accept_encoding: Optional[str] = None)  # downloadLoginLogo
...
## download_login_favicon

```python
bytearray client.download_login_favicon(type: str, key: str, if_none_match: Optional[str] = None, accept_encoding: Optional[str] = None)
```
...
```python
bytearray client.download_login_logo(type: str, key: str, if_none_match: Optional[str] = None, accept_encoding: Optional[str] = None)
```
