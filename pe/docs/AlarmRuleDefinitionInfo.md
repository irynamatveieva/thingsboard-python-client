...
`tb_pe_client.models.AlarmRuleDefinitionInfo`
...
- **Deserialize:** `AlarmRuleDefinitionInfo.model_validate(data)` or `AlarmRuleDefinitionInfo.model_validate_json(json_str)`
