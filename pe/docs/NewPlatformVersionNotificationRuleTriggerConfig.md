...
`tb_pe_client.models.NewPlatformVersionNotificationRuleTriggerConfig`
...
- **Deserialize:** `NewPlatformVersionNotificationRuleTriggerConfig.model_validate(data)` or `NewPlatformVersionNotificationRuleTriggerConfig.model_validate_json(json_str)`
