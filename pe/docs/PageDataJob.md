...
`tb_pe_client.models.PageDataJob`
...
| notification_template_id | NotificationTemplateId |  | [optional] |
| notification_requests | List[NotificationRequest] |  | [optional] |
| originator | EntityId |  | [optional] |
| rule_node | RuleNode |  | [optional] |
| output_tb_msg_proto | str |  | [optional] |
| queue_name | str |  | [optional] |
| scheduler_event_info | EntityInfo |  | [optional] |
...
#### ReportJobResult  *(extends JobResult, job_type=`REPORT`)*
| Name | Type | Description | Notes |
|------|------|-------------|-------|
