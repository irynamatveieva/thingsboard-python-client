...
class LwM2MBootstrapServerCredential(BaseModel):
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[NoSecLwM2MBootstrapServerCredential, PSKLwM2MBootstrapServerCredential, RPKLwM2MBootstrapServerCredential, X509LwM2MBootstrapServerCredential]]:
        ...
        if object_type ==  'NoSecLwM2MBootstrapServerCredential':
            return import_module("tb_pe_client.models.no_sec_lw_m2_m_bootstrap_server_credential").NoSecLwM2MBootstrapServerCredential.from_dict(obj)
        if object_type ==  'PSKLwM2MBootstrapServerCredential':
            return import_module("tb_pe_client.models.psklw_m2_m_bootstrap_server_credential").PSKLwM2MBootstrapServerCredential.from_dict(obj)
        if object_type ==  'RPKLwM2MBootstrapServerCredential':
            return import_module("tb_pe_client.models.rpklw_m2_m_bootstrap_server_credential").RPKLwM2MBootstrapServerCredential.from_dict(obj)
        if object_type ==  'X509LwM2MBootstrapServerCredential':
            return import_module("tb_pe_client.models.x509_lw_m2_m_bootstrap_server_credential").X509LwM2MBootstrapServerCredential.from_dict(obj)
