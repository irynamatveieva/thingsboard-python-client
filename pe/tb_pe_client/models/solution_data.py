...
class SolutionData(BaseModel):
    ...
    """ # noqa: E501
    entities: Dict[str, List[EntityExportData]] = Field(description="Exported entities grouped by entity type. Each key is an entity type (e.g. DEVICE_PROFILE, RULE_CHAIN) and the value is a list of entity export data objects.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SolutionData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SolutionData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "entities": dict(
                (_k,
                        [EntityExportData.from_dict(_item) for _item in _v]
                        if _v is not None
                        else None
                )
