...
class MobilePage(BaseModel):
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[CustomMobilePage, DashboardPage, DefaultMobilePage, WebViewPage]]:
        ...
        if object_type ==  'CustomMobilePage':
            return import_module("tb_pe_client.models.custom_mobile_page").CustomMobilePage.from_dict(obj)
        if object_type ==  'DashboardPage':
            return import_module("tb_pe_client.models.dashboard_page").DashboardPage.from_dict(obj)
        if object_type ==  'DefaultMobilePage':
            return import_module("tb_pe_client.models.default_mobile_page").DefaultMobilePage.from_dict(obj)
        if object_type ==  'WebViewPage':
            return import_module("tb_pe_client.models.web_view_page").WebViewPage.from_dict(obj)
