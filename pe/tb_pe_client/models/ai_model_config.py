...
class AiModelConfig(BaseModel):
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[AmazonBedrockChatModelConfig, AnthropicChatModelConfig, AzureOpenAiChatModelConfig, GitHubModelsChatModelConfig, GoogleAiGeminiChatModelConfig, GoogleVertexAiGeminiChatModelConfig, MistralAiChatModelConfig, OllamaChatModelConfig, OpenAiChatModelConfig]]:
        ...
        if object_type ==  'AmazonBedrockChatModelConfig':
            return import_module("tb_pe_client.models.amazon_bedrock_chat_model_config").AmazonBedrockChatModelConfig.from_dict(obj)
        if object_type ==  'AnthropicChatModelConfig':
            return import_module("tb_pe_client.models.anthropic_chat_model_config").AnthropicChatModelConfig.from_dict(obj)
        if object_type ==  'AzureOpenAiChatModelConfig':
            return import_module("tb_pe_client.models.azure_open_ai_chat_model_config").AzureOpenAiChatModelConfig.from_dict(obj)
        if object_type ==  'GitHubModelsChatModelConfig':
            return import_module("tb_pe_client.models.git_hub_models_chat_model_config").GitHubModelsChatModelConfig.from_dict(obj)
        if object_type ==  'GoogleAiGeminiChatModelConfig':
            return import_module("tb_pe_client.models.google_ai_gemini_chat_model_config").GoogleAiGeminiChatModelConfig.from_dict(obj)
        if object_type ==  'GoogleVertexAiGeminiChatModelConfig':
            return import_module("tb_pe_client.models.google_vertex_ai_gemini_chat_model_config").GoogleVertexAiGeminiChatModelConfig.from_dict(obj)
        if object_type ==  'MistralAiChatModelConfig':
            return import_module("tb_pe_client.models.mistral_ai_chat_model_config").MistralAiChatModelConfig.from_dict(obj)
        if object_type ==  'OllamaChatModelConfig':
            return import_module("tb_pe_client.models.ollama_chat_model_config").OllamaChatModelConfig.from_dict(obj)
        if object_type ==  'OpenAiChatModelConfig':
            return import_module("tb_pe_client.models.open_ai_chat_model_config").OpenAiChatModelConfig.from_dict(obj)
