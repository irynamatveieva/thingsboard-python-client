...
class AttributesImmediateOutputStrategy(AttributesOutputStrategy):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "send_attributes_updated_notification": obj.get("sendAttributesUpdatedNotification"),
            "update_attributes_only_on_value_change": obj.get("updateAttributesOnlyOnValueChange"),
            "save_attribute": obj.get("saveAttribute"),
