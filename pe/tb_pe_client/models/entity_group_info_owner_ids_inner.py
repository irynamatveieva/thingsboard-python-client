...
class EntityGroupInfoOwnerIdsInner(BaseModel):
    ...
    oneof_schema_8_validator: Optional[BlobEntityId] = None
    # data type: CalculatedFieldId
    oneof_schema_9_validator: Optional[CalculatedFieldId] = None
    # data type: ConverterId
    oneof_schema_10_validator: Optional[ConverterId] = None
    # data type: CustomerId
    oneof_schema_11_validator: Optional[CustomerId] = None
    # data type: DashboardId
    oneof_schema_12_validator: Optional[DashboardId] = None
    # data type: DeviceId
    oneof_schema_13_validator: Optional[DeviceId] = None
    # data type: DeviceProfileId
    oneof_schema_14_validator: Optional[DeviceProfileId] = None
    # data type: DomainId
    oneof_schema_15_validator: Optional[DomainId] = None
    # data type: EdgeId
    oneof_schema_16_validator: Optional[EdgeId] = None
    # data type: EntityGroupId
    oneof_schema_17_validator: Optional[EntityGroupId] = None
    # data type: EntityViewId
    oneof_schema_18_validator: Optional[EntityViewId] = None
    # data type: GroupPermissionId
    oneof_schema_19_validator: Optional[GroupPermissionId] = None
    # data type: IntegrationId
    oneof_schema_20_validator: Optional[IntegrationId] = None
    # data type: JobId
    oneof_schema_21_validator: Optional[JobId] = None
    # data type: MobileAppBundleId
    oneof_schema_22_validator: Optional[MobileAppBundleId] = None
    # data type: MobileAppId
    oneof_schema_23_validator: Optional[MobileAppId] = None
    # data type: NotificationId
    oneof_schema_24_validator: Optional[NotificationId] = None
    # data type: NotificationRequestId
    oneof_schema_25_validator: Optional[NotificationRequestId] = None
    # data type: NotificationRuleId
    oneof_schema_26_validator: Optional[NotificationRuleId] = None
    # data type: NotificationTargetId
    oneof_schema_27_validator: Optional[NotificationTargetId] = None
    # data type: NotificationTemplateId
    oneof_schema_28_validator: Optional[NotificationTemplateId] = None
    # data type: OAuth2ClientId
    oneof_schema_29_validator: Optional[OAuth2ClientId] = None
    # data type: OtaPackageId
    oneof_schema_30_validator: Optional[OtaPackageId] = None
    # data type: QueueId
    oneof_schema_31_validator: Optional[QueueId] = None
    # data type: QueueStatsId
    oneof_schema_32_validator: Optional[QueueStatsId] = None
    # data type: ReportId
    oneof_schema_33_validator: Optional[ReportId] = None
    # data type: ReportTemplateId
    oneof_schema_34_validator: Optional[ReportTemplateId] = None
    # data type: RoleId
    oneof_schema_35_validator: Optional[RoleId] = None
    # data type: RpcId
    oneof_schema_36_validator: Optional[RpcId] = None
    # data type: RuleChainId
    oneof_schema_37_validator: Optional[RuleChainId] = None
    # data type: RuleNodeId
    oneof_schema_38_validator: Optional[RuleNodeId] = None
    # data type: SchedulerEventId
    oneof_schema_39_validator: Optional[SchedulerEventId] = None
    # data type: SecretId
    oneof_schema_40_validator: Optional[SecretId] = None
    # data type: TbResourceId
    oneof_schema_41_validator: Optional[TbResourceId] = None
    # data type: TenantId
    oneof_schema_42_validator: Optional[TenantId] = None
    # data type: TenantProfileId
    oneof_schema_43_validator: Optional[TenantProfileId] = None
    # data type: UserId
    oneof_schema_44_validator: Optional[UserId] = None
    # data type: WidgetTypeId
    oneof_schema_45_validator: Optional[WidgetTypeId] = None
    # data type: WidgetsBundleId
    oneof_schema_46_validator: Optional[WidgetsBundleId] = None
