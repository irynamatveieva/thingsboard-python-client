...
class User(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "createdTime", "additionalInfo", "tenantId", "customerId", "email", "authority", "firstName", "lastName", "phone", "customMenuId", "version", "name", "ownerId"]
