...
class NotificationRuleTriggerConfig(BaseModel):
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[AlarmNotificationRuleTriggerConfig, AlarmAssignmentNotificationRuleTriggerConfig, AlarmCommentNotificationRuleTriggerConfig, ApiUsageLimitNotificationRuleTriggerConfig, DeviceActivityNotificationRuleTriggerConfig, EdgeCommunicationFailureNotificationRuleTriggerConfig, EdgeConnectionNotificationRuleTriggerConfig, EntitiesLimitNotificationRuleTriggerConfig, EntityActionNotificationRuleTriggerConfig, IntegrationLifecycleEventNotificationRuleTriggerConfig, NewPlatformVersionNotificationRuleTriggerConfig, RateLimitsNotificationRuleTriggerConfig, ResourcesShortageNotificationRuleTriggerConfig, RuleEngineComponentLifecycleEventNotificationRuleTriggerConfig, TaskProcessingFailureNotificationRuleTriggerConfig]]:
        ...
        if object_type ==  'AlarmNotificationRuleTriggerConfig':
            return import_module("tb_pe_client.models.alarm_notification_rule_trigger_config").AlarmNotificationRuleTriggerConfig.from_dict(obj)
        if object_type ==  'AlarmAssignmentNotificationRuleTriggerConfig':
            return import_module("tb_pe_client.models.alarm_assignment_notification_rule_trigger_config").AlarmAssignmentNotificationRuleTriggerConfig.from_dict(obj)
        if object_type ==  'AlarmCommentNotificationRuleTriggerConfig':
            return import_module("tb_pe_client.models.alarm_comment_notification_rule_trigger_config").AlarmCommentNotificationRuleTriggerConfig.from_dict(obj)
        if object_type ==  'ApiUsageLimitNotificationRuleTriggerConfig':
            return import_module("tb_pe_client.models.api_usage_limit_notification_rule_trigger_config").ApiUsageLimitNotificationRuleTriggerConfig.from_dict(obj)
        if object_type ==  'DeviceActivityNotificationRuleTriggerConfig':
            return import_module("tb_pe_client.models.device_activity_notification_rule_trigger_config").DeviceActivityNotificationRuleTriggerConfig.from_dict(obj)
        if object_type ==  'EdgeCommunicationFailureNotificationRuleTriggerConfig':
            return import_module("tb_pe_client.models.edge_communication_failure_notification_rule_trigger_config").EdgeCommunicationFailureNotificationRuleTriggerConfig.from_dict(obj)
        if object_type ==  'EdgeConnectionNotificationRuleTriggerConfig':
            return import_module("tb_pe_client.models.edge_connection_notification_rule_trigger_config").EdgeConnectionNotificationRuleTriggerConfig.from_dict(obj)
        if object_type ==  'EntitiesLimitNotificationRuleTriggerConfig':
            return import_module("tb_pe_client.models.entities_limit_notification_rule_trigger_config").EntitiesLimitNotificationRuleTriggerConfig.from_dict(obj)
        if object_type ==  'EntityActionNotificationRuleTriggerConfig':
            return import_module("tb_pe_client.models.entity_action_notification_rule_trigger_config").EntityActionNotificationRuleTriggerConfig.from_dict(obj)
        if object_type ==  'IntegrationLifecycleEventNotificationRuleTriggerConfig':
            return import_module("tb_pe_client.models.integration_lifecycle_event_notification_rule_trigger_config").IntegrationLifecycleEventNotificationRuleTriggerConfig.from_dict(obj)
        if object_type ==  'NewPlatformVersionNotificationRuleTriggerConfig':
            return import_module("tb_pe_client.models.new_platform_version_notification_rule_trigger_config").NewPlatformVersionNotificationRuleTriggerConfig.from_dict(obj)
        if object_type ==  'RateLimitsNotificationRuleTriggerConfig':
            return import_module("tb_pe_client.models.rate_limits_notification_rule_trigger_config").RateLimitsNotificationRuleTriggerConfig.from_dict(obj)
        if object_type ==  'ResourcesShortageNotificationRuleTriggerConfig':
            return import_module("tb_pe_client.models.resources_shortage_notification_rule_trigger_config").ResourcesShortageNotificationRuleTriggerConfig.from_dict(obj)
        if object_type ==  'RuleEngineComponentLifecycleEventNotificationRuleTriggerConfig':
            return import_module("tb_pe_client.models.rule_engine_component_lifecycle_event_notification_rule_trigger_config").RuleEngineComponentLifecycleEventNotificationRuleTriggerConfig.from_dict(obj)
        if object_type ==  'TaskProcessingFailureNotificationRuleTriggerConfig':
            return import_module("tb_pe_client.models.task_processing_failure_notification_rule_trigger_config").TaskProcessingFailureNotificationRuleTriggerConfig.from_dict(obj)
