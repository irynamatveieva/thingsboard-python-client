...
class VersionCreateConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["saveRelations", "saveAttributes", "saveCredentials", "saveCalculatedFields", "savePermissions", "saveGroupEntities"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VersionCreateConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VersionCreateConfig from a dict"""
        if obj is None:
            return None
