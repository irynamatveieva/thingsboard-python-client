...
class BulkImportRequest(BaseModel):
    ...
    entity_group_id: Optional[StrictStr] = Field(default=None, serialization_alias="entityGroupId")
    __properties: ClassVar[List[str]] = ["file", "mapping", "customerId", "entityGroupId"]
