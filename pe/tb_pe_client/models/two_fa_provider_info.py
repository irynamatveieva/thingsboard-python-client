...
class TwoFaProviderInfo(BaseModel):
    ...
    min_verification_code_send_period: Optional[StrictInt] = Field(default=None, serialization_alias="minVerificationCodeSendPeriod")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TwoFaProviderInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TwoFaProviderInfo from a dict"""
        if obj is None:
            return None
