...
class ReportTemplateConfig(BaseModel):
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[CsvReportTemplateConfig, PdfReportTemplateConfig]]:
        ...
        if object_type ==  'CsvReportTemplateConfig':
            return import_module("tb_pe_client.models.csv_report_template_config").CsvReportTemplateConfig.from_dict(obj)
        if object_type ==  'PdfReportTemplateConfig':
            return import_module("tb_pe_client.models.pdf_report_template_config").PdfReportTemplateConfig.from_dict(obj)
