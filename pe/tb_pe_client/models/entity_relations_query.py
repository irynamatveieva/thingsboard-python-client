...
class EntityRelationsQuery(BaseModel):
    ...
    filters: Optional[List[RelationEntityTypeFilter]] = Field(default=None, description="Main filters.")
    __properties: ClassVar[List[str]] = ["parameters", "filters"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EntityRelationsQuery from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EntityRelationsQuery from a dict"""
        if obj is None:
            return None
