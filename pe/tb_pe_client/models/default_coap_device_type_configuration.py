...
class DefaultCoapDeviceTypeConfiguration(CoapDeviceTypeConfiguration):
    ...
    __properties: ClassVar[List[str]] = ["coapDeviceType", "transportPayloadTypeConfiguration"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DefaultCoapDeviceTypeConfiguration from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of transport_payload_type_configuration
        if self.transport_payload_type_configuration:
            _dict['transportPayloadTypeConfiguration'] = self.transport_payload_type_configuration.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DefaultCoapDeviceTypeConfiguration from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "coap_device_type": obj.get("coapDeviceType"),
