...
class EntityTypeVersionLoadConfig(BaseModel):
    ...
    load_permissions: Optional[StrictBool] = Field(default=None, serialization_alias="loadPermissions")
    load_group_entities: Optional[StrictBool] = Field(default=None, serialization_alias="loadGroupEntities")
    auto_generate_integration_key: Optional[StrictBool] = Field(default=None, serialization_alias="autoGenerateIntegrationKey")
    ...
    __properties: ClassVar[List[str]] = ["loadRelations", "loadAttributes", "loadCredentials", "loadCalculatedFields", "loadPermissions", "loadGroupEntities", "autoGenerateIntegrationKey", "removeOtherEntities", "findExistingEntityByName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EntityTypeVersionLoadConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EntityTypeVersionLoadConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "load_permissions": obj.get("loadPermissions"),
            "load_group_entities": obj.get("loadGroupEntities"),
            "auto_generate_integration_key": obj.get("autoGenerateIntegrationKey"),
