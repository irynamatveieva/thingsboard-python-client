...
class ReportTemplateInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "createdTime", "tenantId", "customerId", "name", "format", "type", "description", "version", "ownerName", "ownerId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ReportTemplateInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ReportTemplateInfo from a dict"""
        if obj is None:
            return None
