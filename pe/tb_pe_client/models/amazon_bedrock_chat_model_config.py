...
class AmazonBedrockChatModelConfig(AiModelConfig):
    """
    AmazonBedrockChatModelConfig
    """ # noqa: E501
    model_type: Optional[AiModelType] = Field(default=None, alias="modelType")
    provider_config: AmazonBedrockProviderConfig = Field(alias="providerConfig")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AmazonBedrockChatModelConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AmazonBedrockChatModelConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "providerConfig": AmazonBedrockProviderConfig.from_dict(obj["providerConfig"]) if obj.get("providerConfig") is not None else None,
