...
class SlackNotificationTargetConfig(NotificationTargetConfig):
    ...
    """ # noqa: E501
    conversation_type: Optional[SlackConversationType] = Field(default=None, alias="conversationType")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SlackNotificationTargetConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SlackNotificationTargetConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "conversation": SlackConversation.from_dict(obj["conversation"]) if obj.get("conversation") is not None else None
        })
        return _obj
