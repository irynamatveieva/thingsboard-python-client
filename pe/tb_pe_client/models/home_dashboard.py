...
class HomeDashboard(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "createdTime", "tenantId", "customerId", "ownerId", "title", "name", "image", "assignedCustomers", "mobileHide", "mobileOrder", "configuration", "resources", "version", "hideDashboardToolbar"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HomeDashboard from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HomeDashboard from a dict"""
        if obj is None:
            return None
