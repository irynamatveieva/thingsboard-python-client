...
class AccountTwoFaSettings(BaseModel):
    ...
    """ # noqa: E501
    configs: Optional[Dict[str, TwoFaAccountConfig]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountTwoFaSettings from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountTwoFaSettings from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "configs": dict(
                (_k, TwoFaAccountConfig.from_dict(_v))
