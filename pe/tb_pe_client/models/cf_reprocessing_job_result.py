...
class CfReprocessingJobResult(JobResult):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CfReprocessingJobResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CfReprocessingJobResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "successfulCount": obj.get("successfulCount"),
            "failedCount": obj.get("failedCount"),
            "discardedCount": obj.get("discardedCount"),
            ...
            "finishTs": obj.get("finishTs"),
            "cancellationTs": obj.get("cancellationTs"),
