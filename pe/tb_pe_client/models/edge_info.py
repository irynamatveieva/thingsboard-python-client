...
class EdgeInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "createdTime", "tenantId", "customerId", "rootRuleChainId", "name", "type", "label", "routingKey", "secret", "edgeLicenseKey", "cloudEndpoint", "version", "ownerName", "groups", "ownerId", "additionalInfo"]
