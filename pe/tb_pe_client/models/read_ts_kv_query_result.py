...
class ReadTsKvQueryResult(BaseModel):
    ...
    ReadTsKvQueryResult
    """ # noqa: E501
    query_id: Optional[StrictInt] = Field(default=None, serialization_alias="queryId")
    data: Optional[List[TsKvEntry]] = None
    last_entry_ts: Optional[StrictInt] = Field(default=None, serialization_alias="lastEntryTs")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "last_entry_ts": obj.get("lastEntryTs")
        })
        return _obj
