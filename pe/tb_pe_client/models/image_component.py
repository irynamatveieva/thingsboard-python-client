...
class ImageComponent(ReportComponent):
    """
    ImageComponent
    """ # noqa: E501
    ...
    source_type: Optional[ImageSourceType] = Field(default=None, serialization_alias="sourceType")
    image_url: Optional[StrictStr] = Field(default=None, serialization_alias="imageUrl")
    __properties: ClassVar[List[str]] = ["subType", "type", "dataSources", "margins", "paddings", "background", "borderWidth", "borderRadius", "borderColor", "widthType", "customWidth", "alignment", "sourceType", "imageUrl"]
