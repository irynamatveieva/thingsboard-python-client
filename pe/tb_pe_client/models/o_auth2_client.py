...
class OAuth2Client(BaseModel):
    ...
    additional_info: Optional[Any] = Field(description="Additional info of OAuth2 client. Must include: 'providerName' (string, name of the OAuth2 provider).", alias="additionalInfo")
