...
class AggInterval(BaseModel):
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[CustomInterval, DayInterval, HourInterval, MonthInterval, QuarterInterval, WeekInterval, WeekSunSatInterval, YearInterval]]:
        ...
        if object_type ==  'CustomInterval':
            return import_module("tb_pe_client.models.custom_interval").CustomInterval.from_dict(obj)
        if object_type ==  'DayInterval':
            return import_module("tb_pe_client.models.day_interval").DayInterval.from_dict(obj)
        if object_type ==  'HourInterval':
            return import_module("tb_pe_client.models.hour_interval").HourInterval.from_dict(obj)
        if object_type ==  'MonthInterval':
            return import_module("tb_pe_client.models.month_interval").MonthInterval.from_dict(obj)
        if object_type ==  'QuarterInterval':
            return import_module("tb_pe_client.models.quarter_interval").QuarterInterval.from_dict(obj)
        if object_type ==  'WeekInterval':
            return import_module("tb_pe_client.models.week_interval").WeekInterval.from_dict(obj)
        if object_type ==  'WeekSunSatInterval':
            return import_module("tb_pe_client.models.week_sun_sat_interval").WeekSunSatInterval.from_dict(obj)
        if object_type ==  'YearInterval':
            return import_module("tb_pe_client.models.year_interval").YearInterval.from_dict(obj)
