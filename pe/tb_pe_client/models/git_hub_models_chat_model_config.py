...
class GitHubModelsChatModelConfig(AiModelConfig):
    """
    GitHubModelsChatModelConfig
    """ # noqa: E501
    model_type: Optional[AiModelType] = Field(default=None, serialization_alias="modelType")
    provider_config: GitHubModelsProviderConfig = Field(serialization_alias="providerConfig")
    ...
    __properties: ClassVar[List[str]] = ["provider", "modelType", "providerConfig", "modelId", "temperature", "topP", "frequencyPenalty", "presencePenalty", "maxOutputTokens", "timeoutSeconds", "maxRetries"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GitHubModelsChatModelConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GitHubModelsChatModelConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "provider_config": GitHubModelsProviderConfig.from_dict(obj["providerConfig"]) if obj.get("providerConfig") is not None else None,
