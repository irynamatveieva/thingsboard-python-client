...
class GitHubModelsChatModelConfig(AiModelConfig):
    ...
    __properties: ClassVar[List[str]] = ["provider", "providerConfig", "modelId", "temperature", "topP", "frequencyPenalty", "presencePenalty", "maxOutputTokens", "timeoutSeconds", "maxRetries", "modelType"]
