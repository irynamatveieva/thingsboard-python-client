...
class BackupCodeTwoFaAccountConfig(TwoFaAccountConfig):
    ...
    codes_left: Optional[StrictInt] = Field(default=None, alias="codesLeft")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BackupCodeTwoFaAccountConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BackupCodeTwoFaAccountConfig from a dict"""
        if obj is None:
            return None
