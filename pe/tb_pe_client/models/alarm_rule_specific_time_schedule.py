...
class AlarmRuleSpecificTimeSchedule(AlarmRuleSchedule):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "daysOfWeek", "endsOn", "startsOn", "timezone"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AlarmRuleSpecificTimeSchedule from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AlarmRuleSpecificTimeSchedule from a dict"""
        if obj is None:
            return None
