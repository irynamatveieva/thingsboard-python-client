...
class AlarmSchedule(BaseModel):
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[AnyTimeSchedule, CustomTimeSchedule, SpecificTimeSchedule]]:
        ...
        if object_type ==  'AnyTimeSchedule':
            return import_module("tb_pe_client.models.any_time_schedule").AnyTimeSchedule.from_dict(obj)
        if object_type ==  'CustomTimeSchedule':
            return import_module("tb_pe_client.models.custom_time_schedule").CustomTimeSchedule.from_dict(obj)
        if object_type ==  'SpecificTimeSchedule':
            return import_module("tb_pe_client.models.specific_time_schedule").SpecificTimeSchedule.from_dict(obj)
