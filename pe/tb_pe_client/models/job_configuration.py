...
class JobConfiguration(BaseModel):
    ...
    JobConfiguration
    """ # noqa: E501
    tasks_key: Annotated[str, Field(min_length=1, strict=True)] = Field(serialization_alias="tasksKey")
    to_reprocess: Optional[List[TaskResult]] = Field(default=None, serialization_alias="toReprocess")
    type: StrictStr
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[CfReprocessingJobConfiguration, DummyJobConfiguration, ReportJobConfiguration]]:
        ...
        if object_type ==  'CfReprocessingJobConfiguration':
            return import_module("tb_pe_client.models.cf_reprocessing_job_configuration").CfReprocessingJobConfiguration.from_dict(obj)
        if object_type ==  'DummyJobConfiguration':
            return import_module("tb_pe_client.models.dummy_job_configuration").DummyJobConfiguration.from_dict(obj)
        if object_type ==  'ReportJobConfiguration':
            return import_module("tb_pe_client.models.report_job_configuration").ReportJobConfiguration.from_dict(obj)
