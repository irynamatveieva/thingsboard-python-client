...
class SplitViewComponent(ReportComponent):
    """
    SplitViewComponent
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SplitViewComponent from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of left_view
        if self.left_view:
            _dict['leftView'] = self.left_view.to_dict()
        # override the default output from pydantic by calling `to_dict()` of right_view
        if self.right_view:
            _dict['rightView'] = self.right_view.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SplitViewComponent from a dict"""
        if obj is None:
            return None
