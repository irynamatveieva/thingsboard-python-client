...
class CalculatedFieldInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "createdTime", "tenantId", "entityId", "type", "name", "debugMode", "debugSettings", "configurationVersion", "configuration", "version", "entityName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CalculatedFieldInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CalculatedFieldInfo from a dict"""
        if obj is None:
            return None
