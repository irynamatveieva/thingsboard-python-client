...
class PageDataRole(BaseModel):
    ...
    PageDataRole
    """ # noqa: E501
    data: Optional[List[Role]] = Field(default=None, description="Array of the entities")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageDataRole from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageDataRole from a dict"""
        if obj is None:
            return None
