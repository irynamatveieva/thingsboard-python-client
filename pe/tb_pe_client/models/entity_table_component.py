...
class EntityTableComponent(ReportComponent):
    """
    ...
    __properties: ClassVar[List[str]] = ["subType", "type", "dataSources", "margins", "paddings", "background", "borderWidth", "borderRadius", "borderColor", "showTableHeading", "tableHeading", "tableSortOrder"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EntityTableComponent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EntityTableComponent from a dict"""
        if obj is None:
            return None
