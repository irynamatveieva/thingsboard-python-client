...
class EventFilter(BaseModel):
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[CalculatedFieldDebugEventFilter, DebugConverterEventFilter, DebugIntegrationEventFilter, RuleChainDebugEventFilter, RuleNodeDebugEventFilter, ErrorEventFilter, LifeCycleEventFilter, RawDataEventFilter, StatisticsEventFilter]]:
        ...
        if object_type ==  'CalculatedFieldDebugEventFilter':
            return import_module("tb_pe_client.models.calculated_field_debug_event_filter").CalculatedFieldDebugEventFilter.from_dict(obj)
        if object_type ==  'DebugConverterEventFilter':
            return import_module("tb_pe_client.models.debug_converter_event_filter").DebugConverterEventFilter.from_dict(obj)
        if object_type ==  'DebugIntegrationEventFilter':
            return import_module("tb_pe_client.models.debug_integration_event_filter").DebugIntegrationEventFilter.from_dict(obj)
        if object_type ==  'RuleChainDebugEventFilter':
            return import_module("tb_pe_client.models.rule_chain_debug_event_filter").RuleChainDebugEventFilter.from_dict(obj)
        if object_type ==  'RuleNodeDebugEventFilter':
            return import_module("tb_pe_client.models.rule_node_debug_event_filter").RuleNodeDebugEventFilter.from_dict(obj)
        if object_type ==  'ErrorEventFilter':
            return import_module("tb_pe_client.models.error_event_filter").ErrorEventFilter.from_dict(obj)
        if object_type ==  'LifeCycleEventFilter':
            return import_module("tb_pe_client.models.life_cycle_event_filter").LifeCycleEventFilter.from_dict(obj)
        if object_type ==  'RawDataEventFilter':
            return import_module("tb_pe_client.models.raw_data_event_filter").RawDataEventFilter.from_dict(obj)
        if object_type ==  'StatisticsEventFilter':
            return import_module("tb_pe_client.models.statistics_event_filter").StatisticsEventFilter.from_dict(obj)
