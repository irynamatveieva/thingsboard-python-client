...
class RepeatingAlarmCondition(AlarmCondition):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RepeatingAlarmCondition from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RepeatingAlarmCondition from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "schedule": AlarmConditionValueAlarmSchedule.from_dict(obj["schedule"]) if obj.get("schedule") is not None else None,
            "type": obj.get("type"),
