...
class MobileAppDeliveryMethodNotificationTemplate(DeliveryMethodNotificationTemplate):
    ...
    additional_config: Optional[Any] = Field(default=None, description="Additional JSON configuration for web buttons/actions", alias="additionalConfig")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MobileAppDeliveryMethodNotificationTemplate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MobileAppDeliveryMethodNotificationTemplate from a dict"""
        if obj is None:
            return None
