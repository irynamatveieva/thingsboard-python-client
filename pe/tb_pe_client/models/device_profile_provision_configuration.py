...
class DeviceProfileProvisionConfiguration(BaseModel):
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[AllowCreateNewDevicesDeviceProfileProvisionConfiguration, CheckPreProvisionedDevicesDeviceProfileProvisionConfiguration, DisabledDeviceProfileProvisionConfiguration, X509CertificateChainProvisionConfiguration]]:
        ...
        if object_type ==  'AllowCreateNewDevicesDeviceProfileProvisionConfiguration':
            return import_module("tb_pe_client.models.allow_create_new_devices_device_profile_provision_configuration").AllowCreateNewDevicesDeviceProfileProvisionConfiguration.from_dict(obj)
        if object_type ==  'CheckPreProvisionedDevicesDeviceProfileProvisionConfiguration':
            return import_module("tb_pe_client.models.check_pre_provisioned_devices_device_profile_provision_configuration").CheckPreProvisionedDevicesDeviceProfileProvisionConfiguration.from_dict(obj)
        if object_type ==  'DisabledDeviceProfileProvisionConfiguration':
            return import_module("tb_pe_client.models.disabled_device_profile_provision_configuration").DisabledDeviceProfileProvisionConfiguration.from_dict(obj)
        if object_type ==  'X509CertificateChainProvisionConfiguration':
            return import_module("tb_pe_client.models.x509_certificate_chain_provision_configuration").X509CertificateChainProvisionConfiguration.from_dict(obj)
