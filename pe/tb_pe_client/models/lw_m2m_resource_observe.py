...
class LwM2mResourceObserve(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="LwM2M Resource Observe id.")
    name: Optional[StrictStr] = Field(default=None, description="LwM2M Resource Observe name.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LwM2mResourceObserve from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LwM2mResourceObserve from a dict"""
        if obj is None:
            return None
