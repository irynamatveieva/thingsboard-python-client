...
class DeviceSearchQuery(BaseModel):
    ...
    device_types: Optional[List[StrictStr]] = Field(default=None, description="Array of device types to filter the related entities (e.g. 'Temperature Sensor', 'Smoke Sensor').", alias="deviceTypes")
