...
class SingleEntityVersionLoadRequest(VersionLoadRequest):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SingleEntityVersionLoadRequest from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of internal_entity_id
        if self.internal_entity_id:
            _dict['internalEntityId'] = self.internal_entity_id.to_dict()
        # override the default output from pydantic by calling `to_dict()` of external_entity_id
        if self.external_entity_id:
            _dict['externalEntityId'] = self.external_entity_id.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SingleEntityVersionLoadRequest from a dict"""
        if obj is None:
            return None
