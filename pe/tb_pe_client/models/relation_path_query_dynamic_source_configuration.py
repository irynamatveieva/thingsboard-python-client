...
class RelationPathQueryDynamicSourceConfiguration(CfArgumentDynamicSourceConfiguration):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RelationPathQueryDynamicSourceConfiguration from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RelationPathQueryDynamicSourceConfiguration from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "levels": [RelationPathLevel.from_dict(_item) for _item in obj["levels"]] if obj.get("levels") is not None else None
        })
        return _obj
