...
class TbResourceInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "createdTime", "tenantId", "customerId", "title", "resourceType", "resourceSubType", "resourceKey", "publicResourceKey", "etag", "fileName", "descriptor", "link", "name", "public", "publicLink"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TbResourceInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TbResourceInfo from a dict"""
        if obj is None:
            return None
