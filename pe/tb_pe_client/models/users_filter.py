...
class UsersFilter(BaseModel):
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[AffectedTenantAdministratorsFilter, AffectedUserFilter, AllUsersFilter, CustomerUsersFilter, OriginatorEntityOwnerUsersFilter, SystemAdministratorsFilter, TenantAdministratorsFilter, UserGroupListFilter, UserListFilter, UserRoleFilter]]:
        ...
        if object_type ==  'AffectedTenantAdministratorsFilter':
            return import_module("tb_pe_client.models.affected_tenant_administrators_filter").AffectedTenantAdministratorsFilter.from_dict(obj)
        if object_type ==  'AffectedUserFilter':
            return import_module("tb_pe_client.models.affected_user_filter").AffectedUserFilter.from_dict(obj)
        if object_type ==  'AllUsersFilter':
            return import_module("tb_pe_client.models.all_users_filter").AllUsersFilter.from_dict(obj)
        if object_type ==  'CustomerUsersFilter':
            return import_module("tb_pe_client.models.customer_users_filter").CustomerUsersFilter.from_dict(obj)
        if object_type ==  'OriginatorEntityOwnerUsersFilter':
            return import_module("tb_pe_client.models.originator_entity_owner_users_filter").OriginatorEntityOwnerUsersFilter.from_dict(obj)
        if object_type ==  'SystemAdministratorsFilter':
            return import_module("tb_pe_client.models.system_administrators_filter").SystemAdministratorsFilter.from_dict(obj)
        if object_type ==  'TenantAdministratorsFilter':
            return import_module("tb_pe_client.models.tenant_administrators_filter").TenantAdministratorsFilter.from_dict(obj)
        if object_type ==  'UserGroupListFilter':
            return import_module("tb_pe_client.models.user_group_list_filter").UserGroupListFilter.from_dict(obj)
        if object_type ==  'UserListFilter':
            return import_module("tb_pe_client.models.user_list_filter").UserListFilter.from_dict(obj)
        if object_type ==  'UserRoleFilter':
            return import_module("tb_pe_client.models.user_role_filter").UserRoleFilter.from_dict(obj)
