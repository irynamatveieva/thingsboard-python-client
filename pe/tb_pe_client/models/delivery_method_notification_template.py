...
class DeliveryMethodNotificationTemplate(BaseModel):
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[EmailDeliveryMethodNotificationTemplate, MicrosoftTeamsDeliveryMethodNotificationTemplate, MobileAppDeliveryMethodNotificationTemplate, SlackDeliveryMethodNotificationTemplate, SmsDeliveryMethodNotificationTemplate, WebDeliveryMethodNotificationTemplate]]:
        ...
        if object_type ==  'EmailDeliveryMethodNotificationTemplate':
            return import_module("tb_pe_client.models.email_delivery_method_notification_template").EmailDeliveryMethodNotificationTemplate.from_dict(obj)
        if object_type ==  'MicrosoftTeamsDeliveryMethodNotificationTemplate':
            return import_module("tb_pe_client.models.microsoft_teams_delivery_method_notification_template").MicrosoftTeamsDeliveryMethodNotificationTemplate.from_dict(obj)
        if object_type ==  'MobileAppDeliveryMethodNotificationTemplate':
            return import_module("tb_pe_client.models.mobile_app_delivery_method_notification_template").MobileAppDeliveryMethodNotificationTemplate.from_dict(obj)
        if object_type ==  'SlackDeliveryMethodNotificationTemplate':
            return import_module("tb_pe_client.models.slack_delivery_method_notification_template").SlackDeliveryMethodNotificationTemplate.from_dict(obj)
        if object_type ==  'SmsDeliveryMethodNotificationTemplate':
            return import_module("tb_pe_client.models.sms_delivery_method_notification_template").SmsDeliveryMethodNotificationTemplate.from_dict(obj)
        if object_type ==  'WebDeliveryMethodNotificationTemplate':
            return import_module("tb_pe_client.models.web_delivery_method_notification_template").WebDeliveryMethodNotificationTemplate.from_dict(obj)
