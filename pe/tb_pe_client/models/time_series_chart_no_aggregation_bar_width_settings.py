...
class TimeSeriesChartNoAggregationBarWidthSettings(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TimeSeriesChartNoAggregationBarWidthSettings from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of group_width
        if self.group_width:
            _dict['groupWidth'] = self.group_width.to_dict()
        # override the default output from pydantic by calling `to_dict()` of bar_width
        if self.bar_width:
            _dict['barWidth'] = self.bar_width.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TimeSeriesChartNoAggregationBarWidthSettings from a dict"""
        if obj is None:
            return None
