...
class JobControllerApi:
    ...
    def get_jobs(
        ...
        types: Annotated[Optional[List[StrictStr]], Field(description="Comma-separated list of job types to include. If empty - all job types are included.")] = None,
        statuses: Annotated[Optional[List[StrictStr]], Field(description="Comma-separated list of job statuses to include. If empty - all job statuses are included.")] = None,
        entities: Annotated[Optional[List[StrictStr]], Field(description="Comma-separated list of entity ids. If empty - jobs for all entities are included.")] = None,
        start_time: Annotated[Optional[StrictInt], Field(description="To only include jobs created after this timestamp.")] = None,
        end_time: Annotated[Optional[StrictInt], Field(description="To only include jobs created before this timestamp.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type sort_order: str
        :param types: Comma-separated list of job types to include. If empty - all job types are included.
        :type types: List[str]
        :param statuses: Comma-separated list of job statuses to include. If empty - all job statuses are included.
        :type statuses: List[str]
        :param entities: Comma-separated list of entity ids. If empty - jobs for all entities are included.
        :type entities: List[str]
        :param start_time: To only include jobs created after this timestamp.
        :type start_time: int
        :param end_time: To only include jobs created before this timestamp.
        :type end_time: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
