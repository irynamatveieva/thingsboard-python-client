...
class DomainControllerApi:
    ...
    @validate_call
    def get_cloud_domain_info_by_id(
        self,
        id: UUID,
        _request_timeout: Union[
            None,
        ...
        _param = self._get_cloud_domain_info_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_cloud_domain_info_by_id_without_preload_content(
        self,
        id: UUID,
        _request_timeout: Union[
            None,
    ...
    def _get_cloud_domain_info_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/domain/cloud/info/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_domain_info_by_id(
        ...
        _param = self._get_domain_info_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_domain_info_by_id_with_http_info(
        self,
        id: UUID,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_domain_info_by_id_without_preload_content(
        self,
        id: UUID,
        _request_timeout: Union[
            None,
    ...
    def _get_domain_info_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/domain/info/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_domain_infos(
        ...
        text_search: Annotated[Optional[StrictStr], Field(description="Case-insensitive 'substring' filter based on domain's name")] = None,
        ...
        :type page: int
        :param text_search: Case-insensitive 'substring' filter based on domain's name
        ...
        _param = self._get_domain_infos_serialize(
            page_size=page_size,
            page=page,
    ...
    @validate_call
    def get_domain_infos_with_http_info(
        self,
        page_size: Annotated[StrictInt, Field(description="Maximum amount of entities in a one page")],
        page: Annotated[StrictInt, Field(description="Sequence number of page starting from 0")],
        text_search: Annotated[Optional[StrictStr], Field(description="Case-insensitive 'substring' filter based on domain's name")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PageDataDomainInfo]:
        """Get Domain infos (getDomainInfos)
    ...
    def _get_domain_infos_serialize(
        self,
        page_size,
        page,
        text_search,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/domain/infos',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def save_domain(
        self,
        domain: Domain,
        oauth2_client_ids: Annotated[Optional[List[StrictStr]], Field(description="A list of oauth2 client registration ids, separated by comma ','")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type domain: Domain
        :param oauth2_client_ids: A list of oauth2 client registration ids, separated by comma ','
        ...
        _param = self._save_domain_serialize(
            domain=domain,
    ...
    @validate_call
    def save_domain_with_http_info(
        self,
        domain: Domain,
        oauth2_client_ids: Annotated[Optional[List[StrictStr]], Field(description="A list of oauth2 client registration ids, separated by comma ','")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def save_domain_without_preload_content(
        self,
        domain: Domain,
        oauth2_client_ids: Annotated[Optional[List[StrictStr]], Field(description="A list of oauth2 client registration ids, separated by comma ','")] = None,
        _request_timeout: Union[
    ...
    def _update_oauth2_clients_serialize(
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/api/domain/{id}/oauth2Clients',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
