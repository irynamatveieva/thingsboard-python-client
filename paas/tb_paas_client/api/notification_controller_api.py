...
class NotificationControllerApi:
    ...
    @validate_call
    def send_addon_access_error(
        self,
        addon_type: Annotated[StrictStr, Field(description="Addon type")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param addon_type: Addon type (required)
        :type addon_type: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._send_addon_access_error_serialize(
    ...
    @validate_call
    def send_addon_access_error_with_http_info(
        self,
        addon_type: Annotated[StrictStr, Field(description="Addon type")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def send_addon_access_error_without_preload_content(
        self,
        addon_type: Annotated[StrictStr, Field(description="Addon type")],
        _request_timeout: Union[
            None,
    ...
    def _send_addon_access_error_serialize(
        self,
        addon_type,
        _request_auth,
        _content_type,
        ...
        if addon_type is not None:
            _path_params['addonType'] = addon_type
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/notification/sendAddonAccessError/{addonType}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def send_addon_access_request(
        ...
        _param = self._send_addon_access_request_serialize(
            addon_type=addon_type,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def send_addon_access_request_with_http_info(
        self,
        addon_type: Annotated[StrictStr, Field(description="Addon type")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def send_addon_access_request_without_preload_content(
        self,
        addon_type: Annotated[StrictStr, Field(description="Addon type")],
        _request_timeout: Union[
            None,
    ...
    def _send_addon_access_request_serialize(
        self,
        addon_type,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/notification/sendAddonAccessRequest/{addonType}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def send_plan_upgrade_request(
        self,
        plan_name: Annotated[StrictStr, Field(description="Plan name")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param plan_name: Plan name (required)
        :type plan_name: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._send_plan_upgrade_request_serialize(
            plan_name=plan_name,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def send_plan_upgrade_request_with_http_info(
        self,
        plan_name: Annotated[StrictStr, Field(description="Plan name")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def send_plan_upgrade_request_without_preload_content(
        self,
        plan_name: Annotated[StrictStr, Field(description="Plan name")],
        _request_timeout: Union[
            None,
    ...
    def _send_plan_upgrade_request_serialize(
        self,
        plan_name,
        _request_auth,
        _content_type,
        ...
        if plan_name is not None:
            _path_params['planName'] = plan_name
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/notification/sendPlanUpgradeRequest/{planName}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
