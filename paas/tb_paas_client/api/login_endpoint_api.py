...
class LoginEndpointApi:
    ...
    def login(
        self,
        login_request: Annotated[Optional[LoginRequest], Field(description="Login request")] = None,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '401 ': "ThingsboardCredentialsExpiredResponse",
        }
    ...
    def refresh_token(
        self,
        refresh_token_request: Annotated[Optional[RefreshTokenRequest], Field(description="Refresh token request")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param refresh_token_request: Refresh token request
