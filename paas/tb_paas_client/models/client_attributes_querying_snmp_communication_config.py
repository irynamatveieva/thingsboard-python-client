...
class ClientAttributesQueryingSnmpCommunicationConfig(SnmpCommunicationConfig):
    ...
    querying_frequency_ms: Optional[StrictInt] = Field(default=None, alias="queryingFrequencyMs")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClientAttributesQueryingSnmpCommunicationConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClientAttributesQueryingSnmpCommunicationConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "spec": obj.get("spec"),
            "mappings": [SnmpMapping.from_dict(_item) for _item in obj["mappings"]] if obj.get("mappings") is not None else None,
            "queryingFrequencyMs": obj.get("queryingFrequencyMs")
        })
        return _obj
