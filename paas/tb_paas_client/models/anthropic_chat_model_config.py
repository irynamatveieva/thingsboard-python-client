...
class AnthropicChatModelConfig(AiModelConfig):
    """
    AnthropicChatModelConfig
    """ # noqa: E501
    model_type: Optional[AiModelType] = Field(default=None, alias="modelType")
    provider_config: AnthropicProviderConfig = Field(alias="providerConfig")
    ...
    __properties: ClassVar[List[str]] = ["provider", "modelType", "providerConfig", "modelId", "temperature", "topP", "topK", "maxOutputTokens", "timeoutSeconds", "maxRetries"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AnthropicChatModelConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AnthropicChatModelConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "providerConfig": AnthropicProviderConfig.from_dict(obj["providerConfig"]) if obj.get("providerConfig") is not None else None,
