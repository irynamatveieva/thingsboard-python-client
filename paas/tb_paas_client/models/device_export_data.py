...
class DeviceExportData(EntityExportData):
    """
    DeviceExportData
    """ # noqa: E501
    credentials: Optional[DeviceCredentials] = None
    __properties: ClassVar[List[str]] = ["entityType", "entity", "relations", "attributes", "calculatedFields", "credentials"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeviceExportData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeviceExportData from a dict"""
        if obj is None:
            return None
