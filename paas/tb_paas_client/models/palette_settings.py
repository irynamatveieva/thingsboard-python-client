...
class PaletteSettings(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaletteSettings from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of primary_palette
        if self.primary_palette:
            _dict['primaryPalette'] = self.primary_palette.to_dict()
        # override the default output from pydantic by calling `to_dict()` of accent_palette
        if self.accent_palette:
            _dict['accentPalette'] = self.accent_palette.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaletteSettings from a dict"""
        if obj is None:
            return None
