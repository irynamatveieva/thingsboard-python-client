...
class SmsProviderConfiguration(BaseModel):
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[AwsSnsSmsProviderConfiguration, SmppSmsProviderConfiguration, TwilioSmsProviderConfiguration]]:
        ...
        if object_type ==  'AwsSnsSmsProviderConfiguration':
            return import_module("tb_paas_client.models.aws_sns_sms_provider_configuration").AwsSnsSmsProviderConfiguration.from_dict(obj)
        if object_type ==  'SmppSmsProviderConfiguration':
            return import_module("tb_paas_client.models.smpp_sms_provider_configuration").SmppSmsProviderConfiguration.from_dict(obj)
        if object_type ==  'TwilioSmsProviderConfiguration':
            return import_module("tb_paas_client.models.twilio_sms_provider_configuration").TwilioSmsProviderConfiguration.from_dict(obj)
