...
class EntityExportData(BaseModel):
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[AiModelExportData, AssetExportData, AssetProfileExportData, ConverterExportData, CustomerExportData, DashboardExportData, DeviceExportData, DeviceProfileExportData, EntityGroupExportData, EntityViewExportData, IntegrationExportData, NotificationRuleExportData, NotificationTargetExportData, NotificationTemplateExportData, OtaPackageExportData, ReportTemplateExportData, RoleExportData, RuleChainExportData, SchedulerEventExportData, TbResourceExportData, WidgetsBundleExportData, WidgetTypeExportData]]:
        ...
        if object_type ==  'AiModelExportData':
            return import_module("tb_paas_client.models.ai_model_export_data").AiModelExportData.from_dict(obj)
        if object_type ==  'AssetExportData':
            return import_module("tb_paas_client.models.asset_export_data").AssetExportData.from_dict(obj)
        if object_type ==  'AssetProfileExportData':
            return import_module("tb_paas_client.models.asset_profile_export_data").AssetProfileExportData.from_dict(obj)
        if object_type ==  'ConverterExportData':
            return import_module("tb_paas_client.models.converter_export_data").ConverterExportData.from_dict(obj)
        if object_type ==  'CustomerExportData':
            return import_module("tb_paas_client.models.customer_export_data").CustomerExportData.from_dict(obj)
        if object_type ==  'DashboardExportData':
            return import_module("tb_paas_client.models.dashboard_export_data").DashboardExportData.from_dict(obj)
        if object_type ==  'DeviceExportData':
            return import_module("tb_paas_client.models.device_export_data").DeviceExportData.from_dict(obj)
        if object_type ==  'DeviceProfileExportData':
            return import_module("tb_paas_client.models.device_profile_export_data").DeviceProfileExportData.from_dict(obj)
        if object_type ==  'EntityGroupExportData':
            return import_module("tb_paas_client.models.entity_group_export_data").EntityGroupExportData.from_dict(obj)
        if object_type ==  'EntityViewExportData':
            return import_module("tb_paas_client.models.entity_view_export_data").EntityViewExportData.from_dict(obj)
        if object_type ==  'IntegrationExportData':
            return import_module("tb_paas_client.models.integration_export_data").IntegrationExportData.from_dict(obj)
        if object_type ==  'NotificationRuleExportData':
            return import_module("tb_paas_client.models.notification_rule_export_data").NotificationRuleExportData.from_dict(obj)
        if object_type ==  'NotificationTargetExportData':
            return import_module("tb_paas_client.models.notification_target_export_data").NotificationTargetExportData.from_dict(obj)
        if object_type ==  'NotificationTemplateExportData':
            return import_module("tb_paas_client.models.notification_template_export_data").NotificationTemplateExportData.from_dict(obj)
        if object_type ==  'OtaPackageExportData':
            return import_module("tb_paas_client.models.ota_package_export_data").OtaPackageExportData.from_dict(obj)
        if object_type ==  'ReportTemplateExportData':
            return import_module("tb_paas_client.models.report_template_export_data").ReportTemplateExportData.from_dict(obj)
        if object_type ==  'RoleExportData':
            return import_module("tb_paas_client.models.role_export_data").RoleExportData.from_dict(obj)
        if object_type ==  'RuleChainExportData':
            return import_module("tb_paas_client.models.rule_chain_export_data").RuleChainExportData.from_dict(obj)
        if object_type ==  'SchedulerEventExportData':
            return import_module("tb_paas_client.models.scheduler_event_export_data").SchedulerEventExportData.from_dict(obj)
        if object_type ==  'TbResourceExportData':
            return import_module("tb_paas_client.models.tb_resource_export_data").TbResourceExportData.from_dict(obj)
        if object_type ==  'WidgetsBundleExportData':
            return import_module("tb_paas_client.models.widgets_bundle_export_data").WidgetsBundleExportData.from_dict(obj)
        if object_type ==  'WidgetTypeExportData':
            return import_module("tb_paas_client.models.widget_type_export_data").WidgetTypeExportData.from_dict(obj)
