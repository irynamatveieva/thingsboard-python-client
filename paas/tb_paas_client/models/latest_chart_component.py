...
class LatestChartComponent(ReportComponent):
    ...
    __properties: ClassVar[List[str]] = ["type", "subType", "dataSources", "margins", "paddings", "background", "borderWidth", "borderRadius", "borderColor", "widthType", "customWidth", "alignment", "height", "latestChartSettings"]
