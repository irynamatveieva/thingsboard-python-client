...
class SchedulerEventWithCustomerInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "createdTime", "tenantId", "customerId", "originatorId", "name", "type", "schedule", "enabled", "version", "customerTitle", "customerIsPublic", "timestamps", "ownerId", "additionalInfo"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SchedulerEventWithCustomerInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SchedulerEventWithCustomerInfo from a dict"""
        if obj is None:
            return None
