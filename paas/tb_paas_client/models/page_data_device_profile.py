...
class PageDataDeviceProfile(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[List[DeviceProfile]] = Field(default=None, description="Array of the entities")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageDataDeviceProfile from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageDataDeviceProfile from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": [DeviceProfile.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
