...
class EdgeConnectionNotificationRuleTriggerConfig(NotificationRuleTriggerConfig):
    ...
    notify_on: Optional[List[EdgeConnectivityEvent]] = Field(default=None, alias="notifyOn")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EdgeConnectionNotificationRuleTriggerConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EdgeConnectionNotificationRuleTriggerConfig from a dict"""
        if obj is None:
            return None
