...
class TenantInfo(BaseModel):
    ...
    last_inactive_ts: Optional[StrictInt] = Field(default=None, serialization_alias="lastInactiveTs")
    current_period_start_ts: Optional[StrictInt] = Field(default=None, serialization_alias="currentPeriodStartTs")
    addon_data: Optional[TenantAddonData] = Field(default=None, serialization_alias="addonData")
    edge_license_version: Optional[StrictInt] = Field(default=None, serialization_alias="edgeLicenseVersion")
    ...
    __properties: ClassVar[List[str]] = ["id", "createdTime", "additionalInfo", "country", "state", "city", "address", "address2", "zip", "phone", "email", "title", "region", "tenantProfileId", "version", "active", "lastInactiveTs", "currentPeriodStartTs", "addonData", "edgeLicenseVersion", "tenantProfileName", "name"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of addon_data
        if self.addon_data:
            _dict['addonData'] = self.addon_data.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "last_inactive_ts": obj.get("lastInactiveTs"),
            "current_period_start_ts": obj.get("currentPeriodStartTs"),
            "addon_data": TenantAddonData.from_dict(obj["addonData"]) if obj.get("addonData") is not None else None,
            "edge_license_version": obj.get("edgeLicenseVersion"),
