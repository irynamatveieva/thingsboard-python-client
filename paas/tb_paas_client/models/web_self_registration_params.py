...
class WebSelfRegistrationParams(SelfRegistrationParams):
    ...
    __properties: ClassVar[List[str]] = ["permissions", "type", "showPrivacyPolicy", "showTermsOfUse", "title", "enabled", "homeDashboard", "notificationRecipient", "captcha", "signUpFields", "defaultDashboard", "customerTitlePrefix", "customMenuId", "customerGroupId", "privacyPolicy", "termsOfUse", "domainId"]
