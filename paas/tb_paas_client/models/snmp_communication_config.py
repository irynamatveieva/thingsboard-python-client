...
class SnmpCommunicationConfig(BaseModel):
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[ClientAttributesQueryingSnmpCommunicationConfig, SharedAttributesSettingSnmpCommunicationConfig, TelemetryQueryingSnmpCommunicationConfig, ToDeviceRpcRequestSnmpCommunicationConfig, ToServerRpcRequestSnmpCommunicationConfig]]:
        ...
        if object_type ==  'ClientAttributesQueryingSnmpCommunicationConfig':
            return import_module("tb_paas_client.models.client_attributes_querying_snmp_communication_config").ClientAttributesQueryingSnmpCommunicationConfig.from_dict(obj)
        if object_type ==  'SharedAttributesSettingSnmpCommunicationConfig':
            return import_module("tb_paas_client.models.shared_attributes_setting_snmp_communication_config").SharedAttributesSettingSnmpCommunicationConfig.from_dict(obj)
        if object_type ==  'TelemetryQueryingSnmpCommunicationConfig':
            return import_module("tb_paas_client.models.telemetry_querying_snmp_communication_config").TelemetryQueryingSnmpCommunicationConfig.from_dict(obj)
        if object_type ==  'ToDeviceRpcRequestSnmpCommunicationConfig':
            return import_module("tb_paas_client.models.to_device_rpc_request_snmp_communication_config").ToDeviceRpcRequestSnmpCommunicationConfig.from_dict(obj)
        if object_type ==  'ToServerRpcRequestSnmpCommunicationConfig':
            return import_module("tb_paas_client.models.to_server_rpc_request_snmp_communication_config").ToServerRpcRequestSnmpCommunicationConfig.from_dict(obj)
