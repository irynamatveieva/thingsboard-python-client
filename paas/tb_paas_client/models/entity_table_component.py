...
class EntityTableComponent(ReportComponent):
    ...
    __properties: ClassVar[List[str]] = ["type", "subType", "dataSources", "margins", "paddings", "background", "borderWidth", "borderRadius", "borderColor", "showTableHeading", "tableHeading", "tableSortOrder"]
