...
class LwM2MServerSecurityConfigDefault(BaseModel):
    ...
    security_host: Optional[StrictStr] = Field(default=None, description="Host for 'Security' mode (DTLS)", serialization_alias="securityHost")
    security_port: Optional[StrictInt] = Field(default=None, description="Port for 'Security' mode (DTLS): Lwm2m Server or Bootstrap Server", serialization_alias="securityPort")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "security_host": obj.get("securityHost"),
            "security_port": obj.get("securityPort")
        })
        return _obj
