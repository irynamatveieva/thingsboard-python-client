...
class IntegrationLifecycleEventNotificationRuleTriggerConfig(NotificationRuleTriggerConfig):
    ...
    only_on_error: Optional[StrictBool] = Field(default=None, serialization_alias="onlyOnError")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "integration_types": obj.get("integrationTypes"),
            "integrations": obj.get("integrations"),
            "notify_on": obj.get("notifyOn"),
            "only_on_error": obj.get("onlyOnError")
        })
        return _obj
