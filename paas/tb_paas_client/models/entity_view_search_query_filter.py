...
class EntityViewSearchQueryFilter(EntityFilter):
    ...
    __properties: ClassVar[List[str]] = ["type", "rootEntity", "relationType", "direction", "maxLevel", "fetchLastLevelOnly", "rootStateEntity", "defaultStateEntity", "entityViewTypes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EntityViewSearchQueryFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EntityViewSearchQueryFilter from a dict"""
        if obj is None:
            return None
