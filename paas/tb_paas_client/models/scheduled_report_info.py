...
class ScheduledReportInfo(BaseModel):
    """
    ScheduledReportInfo
    """ # noqa: E501
    ...
    template_info: Optional[EntityInfo] = Field(default=None, description="Report template info", serialization_alias="templateInfo")
    customer_title: Optional[StrictStr] = Field(default=None, description="Customer title", serialization_alias="customerTitle")
    user_name: Optional[StrictStr] = Field(default=None, description="Report user name", serialization_alias="userName")
    ...
    __properties: ClassVar[List[str]] = ["id", "createdTime", "additionalInfo", "tenantId", "customerId", "originatorId", "name", "type", "schedule", "enabled", "version", "templateInfo", "customerTitle", "userName", "ownerId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ScheduledReportInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ScheduledReportInfo from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "template_info": EntityInfo.from_dict(obj["templateInfo"]) if obj.get("templateInfo") is not None else None,
