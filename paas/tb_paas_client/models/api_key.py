...
class ApiKey(BaseModel):
    ...
    value: StrictStr = Field(description="API key value")
    ...
    __properties: ClassVar[List[str]] = ["id", "createdTime", "tenantId", "userId", "expirationTime", "description", "enabled", "value", "expired"]
