...
class FilterPredicateValueString(BaseModel):
    ...
    user_value: Optional[StrictStr] = Field(default=None, serialization_alias="userValue")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FilterPredicateValueString from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FilterPredicateValueString from a dict"""
        if obj is None:
            return None
