...
class EntityFilter(BaseModel):
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[ApiUsageStateFilter, AssetSearchQueryFilter, AssetTypeFilter, DeviceSearchQueryFilter, DeviceTypeFilter, EdgeSearchQueryFilter, EdgeTypeFilter, EntitiesByGroupNameFilter, EntityGroupFilter, EntityGroupListFilter, EntityGroupNameFilter, EntityListFilter, EntityNameFilter, EntityTypeFilter, EntityViewSearchQueryFilter, EntityViewTypeFilter, RelationsQueryFilter, SchedulerEventFilter, SingleEntityFilter, StateEntityFilter, StateEntityOwnerFilter]]:
        ...
        if object_type ==  'ApiUsageStateFilter':
            return import_module("tb_paas_client.models.api_usage_state_filter").ApiUsageStateFilter.from_dict(obj)
        if object_type ==  'AssetSearchQueryFilter':
            return import_module("tb_paas_client.models.asset_search_query_filter").AssetSearchQueryFilter.from_dict(obj)
        if object_type ==  'AssetTypeFilter':
            return import_module("tb_paas_client.models.asset_type_filter").AssetTypeFilter.from_dict(obj)
        if object_type ==  'DeviceSearchQueryFilter':
            return import_module("tb_paas_client.models.device_search_query_filter").DeviceSearchQueryFilter.from_dict(obj)
        if object_type ==  'DeviceTypeFilter':
            return import_module("tb_paas_client.models.device_type_filter").DeviceTypeFilter.from_dict(obj)
        if object_type ==  'EdgeSearchQueryFilter':
            return import_module("tb_paas_client.models.edge_search_query_filter").EdgeSearchQueryFilter.from_dict(obj)
        if object_type ==  'EdgeTypeFilter':
            return import_module("tb_paas_client.models.edge_type_filter").EdgeTypeFilter.from_dict(obj)
        if object_type ==  'EntitiesByGroupNameFilter':
            return import_module("tb_paas_client.models.entities_by_group_name_filter").EntitiesByGroupNameFilter.from_dict(obj)
        if object_type ==  'EntityGroupFilter':
            return import_module("tb_paas_client.models.entity_group_filter").EntityGroupFilter.from_dict(obj)
        if object_type ==  'EntityGroupListFilter':
            return import_module("tb_paas_client.models.entity_group_list_filter").EntityGroupListFilter.from_dict(obj)
        if object_type ==  'EntityGroupNameFilter':
            return import_module("tb_paas_client.models.entity_group_name_filter").EntityGroupNameFilter.from_dict(obj)
        if object_type ==  'EntityListFilter':
            return import_module("tb_paas_client.models.entity_list_filter").EntityListFilter.from_dict(obj)
        if object_type ==  'EntityNameFilter':
            return import_module("tb_paas_client.models.entity_name_filter").EntityNameFilter.from_dict(obj)
        if object_type ==  'EntityTypeFilter':
            return import_module("tb_paas_client.models.entity_type_filter").EntityTypeFilter.from_dict(obj)
        if object_type ==  'EntityViewSearchQueryFilter':
            return import_module("tb_paas_client.models.entity_view_search_query_filter").EntityViewSearchQueryFilter.from_dict(obj)
        if object_type ==  'EntityViewTypeFilter':
            return import_module("tb_paas_client.models.entity_view_type_filter").EntityViewTypeFilter.from_dict(obj)
        if object_type ==  'RelationsQueryFilter':
            return import_module("tb_paas_client.models.relations_query_filter").RelationsQueryFilter.from_dict(obj)
        if object_type ==  'SchedulerEventFilter':
            return import_module("tb_paas_client.models.scheduler_event_filter").SchedulerEventFilter.from_dict(obj)
        if object_type ==  'SingleEntityFilter':
            return import_module("tb_paas_client.models.single_entity_filter").SingleEntityFilter.from_dict(obj)
        if object_type ==  'StateEntityFilter':
            return import_module("tb_paas_client.models.state_entity_filter").StateEntityFilter.from_dict(obj)
        if object_type ==  'StateEntityOwnerFilter':
            return import_module("tb_paas_client.models.state_entity_owner_filter").StateEntityOwnerFilter.from_dict(obj)
