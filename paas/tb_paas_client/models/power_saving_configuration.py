...
class PowerSavingConfiguration(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["powerMode", "psmActivityTimer", "edrxCycle", "pagingTransmissionWindow"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PowerSavingConfiguration from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PowerSavingConfiguration from a dict"""
        if obj is None:
            return None
