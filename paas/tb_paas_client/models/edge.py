...
class Edge(BaseModel):
    ...
    edge_license_type: Optional[EdgeLicenseType] = Field(default=None, alias="edgeLicenseType")
    ...
    __properties: ClassVar[List[str]] = ["id", "createdTime", "tenantId", "customerId", "rootRuleChainId", "name", "type", "label", "routingKey", "secret", "edgeLicenseKey", "cloudEndpoint", "edgeLicenseType", "version", "ownerId", "additionalInfo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "edgeLicenseType": obj.get("edgeLicenseType"),
