...
class SlackNotificationDeliveryMethodConfig(NotificationDeliveryMethodConfig):
    ...
    """ # noqa: E501
    bot_token: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="botToken")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SlackNotificationDeliveryMethodConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SlackNotificationDeliveryMethodConfig from a dict"""
        if obj is None:
            return None
