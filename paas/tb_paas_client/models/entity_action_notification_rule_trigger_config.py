...
class EntityActionNotificationRuleTriggerConfig(NotificationRuleTriggerConfig):
    ...
    __properties: ClassVar[List[str]] = ["triggerType", "entityTypes", "created", "updated", "deleted"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EntityActionNotificationRuleTriggerConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EntityActionNotificationRuleTriggerConfig from a dict"""
        if obj is None:
            return None
