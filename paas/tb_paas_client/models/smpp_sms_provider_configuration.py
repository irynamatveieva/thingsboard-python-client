...
class SmppSmsProviderConfiguration(SmsProviderConfiguration):
    ...
    """ # noqa: E501
    protocol_version: StrictStr = Field(description="SMPP version", alias="protocolVersion")
    host: StrictStr = Field(description="SMPP host")
    port: StrictInt = Field(description="SMPP port")
    system_id: StrictStr = Field(description="System ID", alias="systemId")
    ...
    bind_type: Optional[SmppBindType] = Field(default=None, description="TX - Transmitter, RX - Receiver, TRX - Transciever. By default TX is used", alias="bindType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bindType": obj.get("bindType"),
            "serviceType": obj.get("serviceType"),
            "sourceAddress": obj.get("sourceAddress"),
            "sourceTon": obj.get("sourceTon"),
            "sourceNpi": obj.get("sourceNpi"),
            "destinationTon": obj.get("destinationTon"),
            "destinationNpi": obj.get("destinationNpi"),
            "addressRange": obj.get("addressRange"),
            "codingScheme": obj.get("codingScheme")
        })
        return _obj
