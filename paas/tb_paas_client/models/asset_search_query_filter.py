...
class AssetSearchQueryFilter(EntityFilter):
    ...
    __properties: ClassVar[List[str]] = ["type", "rootEntity", "relationType", "direction", "maxLevel", "fetchLastLevelOnly", "rootStateEntity", "defaultStateEntity", "assetTypes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssetSearchQueryFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssetSearchQueryFilter from a dict"""
        if obj is None:
            return None
