...
class PlatformTwoFaSettings(BaseModel):
    ...
    Settings value
    """ # noqa: E501
    use_system_two_factor_auth_settings: Optional[StrictBool] = Field(default=None, alias="useSystemTwoFactorAuthSettings")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "useSystemTwoFactorAuthSettings": obj.get("useSystemTwoFactorAuthSettings"),
