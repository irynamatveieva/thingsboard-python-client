...
class DefaultTenantProfileConfiguration(TenantProfileConfiguration):
    ...
    max_report_size_in_bytes: Optional[StrictInt] = Field(default=None, serialization_alias="maxReportSizeInBytes")
    ...
    max_scheduler_events: Optional[StrictInt] = Field(default=None, serialization_alias="maxSchedulerEvents")
    ...
    integration_msgs_per_tenant_rate_limit: Optional[StrictStr] = Field(default=None, serialization_alias="integrationMsgsPerTenantRateLimit")
    integration_msgs_per_device_rate_limit: Optional[StrictStr] = Field(default=None, serialization_alias="integrationMsgsPerDeviceRateLimit")
    integration_msgs_per_asset_rate_limit: Optional[StrictStr] = Field(default=None, serialization_alias="integrationMsgsPerAssetRateLimit")
    ...
    max_generated_reports: Optional[StrictInt] = Field(default=None, serialization_alias="maxGeneratedReports")
    ...
    blob_entity_ttl_days: Optional[StrictInt] = Field(default=None, serialization_alias="blobEntityTtlDays")
    report_ttl_days: Optional[StrictInt] = Field(default=None, serialization_alias="reportTtlDays")
    ...
    ai_chat_requests_per_tenant_rate_limit: Optional[StrictStr] = Field(default=None, serialization_alias="aiChatRequestsPerTenantRateLimit")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "max_report_size_in_bytes": obj.get("maxReportSizeInBytes"),
            "max_integrations": obj.get("maxIntegrations"),
            "max_converters": obj.get("maxConverters"),
            "max_scheduler_events": obj.get("maxSchedulerEvents"),
            ...
            "integration_msgs_per_tenant_rate_limit": obj.get("integrationMsgsPerTenantRateLimit"),
            "integration_msgs_per_device_rate_limit": obj.get("integrationMsgsPerDeviceRateLimit"),
            "integration_msgs_per_asset_rate_limit": obj.get("integrationMsgsPerAssetRateLimit"),
            ...
            "max_generated_reports": obj.get("maxGeneratedReports"),
            ...
            "blob_entity_ttl_days": obj.get("blobEntityTtlDays"),
            "report_ttl_days": obj.get("reportTtlDays"),
            "warn_threshold": obj.get("warnThreshold"),
            "max_calculated_fields_per_entity": obj.get("maxCalculatedFieldsPerEntity"),
            "max_arguments_per_c_f": obj.get("maxArgumentsPerCF"),
            "min_allowed_scheduled_update_interval_in_sec_for_c_f": obj.get("minAllowedScheduledUpdateIntervalInSecForCF"),
            ...
            "min_allowed_deduplication_interval_in_sec_for_c_f": obj.get("minAllowedDeduplicationIntervalInSecForCF"),
            "min_allowed_aggregation_interval_in_sec_for_c_f": obj.get("minAllowedAggregationIntervalInSecForCF"),
            "intermediate_aggregation_interval_in_sec_for_c_f": obj.get("intermediateAggregationIntervalInSecForCF"),
            ...
            "ai_chat_requests_per_tenant_rate_limit": obj.get("aiChatRequestsPerTenantRateLimit")
        })
        return _obj
