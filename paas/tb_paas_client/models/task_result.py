...
class TaskResult(BaseModel):
    ...
    finish_ts: Optional[StrictInt] = Field(default=None, alias="finishTs")
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[CfReprocessingTaskResult, DummyTaskResult, ReportTaskResult]]:
        ...
        if object_type ==  'CfReprocessingTaskResult':
            return import_module("tb_paas_client.models.cf_reprocessing_task_result").CfReprocessingTaskResult.from_dict(obj)
        if object_type ==  'DummyTaskResult':
            return import_module("tb_paas_client.models.dummy_task_result").DummyTaskResult.from_dict(obj)
        if object_type ==  'ReportTaskResult':
            return import_module("tb_paas_client.models.report_task_result").ReportTaskResult.from_dict(obj)
