...
class TwoFaAccountConfig(BaseModel):
    ...
    """ # noqa: E501
    use_by_default: Optional[StrictBool] = Field(default=None, serialization_alias="useByDefault")
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[BackupCodeTwoFaAccountConfig, EmailTwoFaAccountConfig, SmsTwoFaAccountConfig, TotpTwoFaAccountConfig]]:
        ...
        if object_type ==  'BackupCodeTwoFaAccountConfig':
            return import_module("tb_paas_client.models.backup_code_two_fa_account_config").BackupCodeTwoFaAccountConfig.from_dict(obj)
        if object_type ==  'EmailTwoFaAccountConfig':
            return import_module("tb_paas_client.models.email_two_fa_account_config").EmailTwoFaAccountConfig.from_dict(obj)
        if object_type ==  'SmsTwoFaAccountConfig':
            return import_module("tb_paas_client.models.sms_two_fa_account_config").SmsTwoFaAccountConfig.from_dict(obj)
        if object_type ==  'TotpTwoFaAccountConfig':
            return import_module("tb_paas_client.models.totp_two_fa_account_config").TotpTwoFaAccountConfig.from_dict(obj)
