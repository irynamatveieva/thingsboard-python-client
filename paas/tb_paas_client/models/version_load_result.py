...
class VersionLoadResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["result", "error", "done"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VersionLoadResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VersionLoadResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "result": [EntityTypeLoadResult.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
            "error": EntityLoadError.from_dict(obj["error"]) if obj.get("error") is not None else None,
            "done": obj.get("done")
        })
        return _obj
