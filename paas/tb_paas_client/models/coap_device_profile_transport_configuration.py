...
class CoapDeviceProfileTransportConfiguration(DeviceProfileTransportConfiguration):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoapDeviceProfileTransportConfiguration from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of coap_device_type_configuration
        if self.coap_device_type_configuration:
            _dict['coapDeviceTypeConfiguration'] = self.coap_device_type_configuration.to_dict()
        # override the default output from pydantic by calling `to_dict()` of client_settings
        if self.client_settings:
            _dict['clientSettings'] = self.client_settings.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoapDeviceProfileTransportConfiguration from a dict"""
        if obj is None:
            return None
