...
class LoginWhiteLabelingParams(BaseModel):
    ...
    page_background_color: Optional[StrictStr] = Field(default=None, description="Login page background color", alias="pageBackgroundColor")
    dark_foreground: Optional[StrictBool] = Field(default=None, description="Enable/Disable dark foreground", alias="darkForeground")
    domain_id: Optional[DomainId] = Field(default=None, description="Domain id", alias="domainId")
    base_url: Optional[StrictStr] = Field(default=None, description="Base URL for the activation link, etc", alias="baseUrl")
    prohibit_different_url: Optional[StrictBool] = Field(default=None, description="Prohibit use of other URLs. It is recommended to enable this setting", alias="prohibitDifferentUrl")
    admin_settings_id: Optional[StrictStr] = Field(default=None, description="Id of the settings object that store this parameters", alias="adminSettingsId")
    show_name_bottom: Optional[StrictBool] = Field(default=None, description="Show platform name and version on login page", alias="showNameBottom")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pageBackgroundColor": obj.get("pageBackgroundColor"),
            "darkForeground": obj.get("darkForeground"),
            "domainId": DomainId.from_dict(obj["domainId"]) if obj.get("domainId") is not None else None,
            "baseUrl": obj.get("baseUrl"),
            "prohibitDifferentUrl": obj.get("prohibitDifferentUrl"),
            "adminSettingsId": obj.get("adminSettingsId"),
            "showNameBottom": obj.get("showNameBottom")
        })
        return _obj
