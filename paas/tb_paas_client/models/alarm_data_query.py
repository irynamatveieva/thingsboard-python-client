...
class AlarmDataQuery(BaseModel):
    ...
    page_link: Optional[AlarmDataPageLink] = Field(default=None, serialization_alias="pageLink")
    ...
    alarm_fields: Optional[List[EntityKey]] = Field(default=None, serialization_alias="alarmFields")
    __properties: ClassVar[List[str]] = ["entityFilter", "keyFilters", "pageLink", "entityFields", "latestValues", "alarmFields"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AlarmDataQuery from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in alarm_fields (list)
        _items = []
        if self.alarm_fields:
            for _item_alarm_fields in self.alarm_fields:
                if _item_alarm_fields:
                    _items.append(_item_alarm_fields.to_dict())
            _dict['alarmFields'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AlarmDataQuery from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "page_link": AlarmDataPageLink.from_dict(obj["pageLink"]) if obj.get("pageLink") is not None else None,
            ...
            "alarm_fields": [EntityKey.from_dict(_item) for _item in obj["alarmFields"]] if obj.get("alarmFields") is not None else None
        })
        return _obj
