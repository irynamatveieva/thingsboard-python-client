...
class AlarmDataQuery(BaseModel):
    ...
    page_link: Optional[AlarmDataPageLink] = Field(default=None, alias="pageLink")
    ...
    alarm_fields: Optional[List[EntityKey]] = Field(default=None, alias="alarmFields")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pageLink": AlarmDataPageLink.from_dict(obj["pageLink"]) if obj.get("pageLink") is not None else None,
            ...
            "alarmFields": [EntityKey.from_dict(_item) for _item in obj["alarmFields"]] if obj.get("alarmFields") is not None else None
        })
        return _obj
