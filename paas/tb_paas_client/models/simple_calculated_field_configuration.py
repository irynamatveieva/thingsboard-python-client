...
class SimpleCalculatedFieldConfiguration(CalculatedFieldConfiguration):
    ...
    __properties: ClassVar[List[str]] = ["type", "output", "arguments", "expression", "useLatestTs"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SimpleCalculatedFieldConfiguration from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SimpleCalculatedFieldConfiguration from a dict"""
        if obj is None:
            return None
