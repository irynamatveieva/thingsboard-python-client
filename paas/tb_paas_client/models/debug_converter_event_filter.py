...
class DebugConverterEventFilter(EventFilter):
    ...
    var_in: Optional[StrictStr] = Field(default=None, serialization_alias="in")
    out: Optional[StrictStr] = None
    metadata: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["eventType", "notEmpty", "server", "isError", "errorStr", "type", "in", "out", "metadata"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DebugConverterEventFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DebugConverterEventFilter from a dict"""
        if obj is None:
            return None
