...
class RuleChainExportData(EntityExportData):
    """
    RuleChainExportData
    """ # noqa: E501
    meta_data: Optional[RuleChainMetaData] = Field(default=None, alias="metaData")
    __properties: ClassVar[List[str]] = ["entityType", "entity", "relations", "attributes", "calculatedFields", "metaData"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RuleChainExportData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RuleChainExportData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "metaData": RuleChainMetaData.from_dict(obj["metaData"]) if obj.get("metaData") is not None else None
        })
        return _obj
