...
class ScriptCalculatedFieldConfiguration(CalculatedFieldConfiguration):
    ...
    __properties: ClassVar[List[str]] = ["output", "aiGenerated", "type", "arguments", "expression"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ScriptCalculatedFieldConfiguration from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ScriptCalculatedFieldConfiguration from a dict"""
        if obj is None:
            return None
