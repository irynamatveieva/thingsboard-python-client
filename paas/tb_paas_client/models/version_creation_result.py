...
class VersionCreationResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["version", "added", "modified", "removed", "error", "done"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VersionCreationResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VersionCreationResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "version": EntityVersion.from_dict(obj["version"]) if obj.get("version") is not None else None,
            "added": obj.get("added"),
