...
class CustomMobilePage(MobilePage):
    ...
    __properties: ClassVar[List[str]] = ["type", "visible", "label", "icon", "path"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CustomMobilePage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CustomMobilePage from a dict"""
        if obj is None:
            return None
