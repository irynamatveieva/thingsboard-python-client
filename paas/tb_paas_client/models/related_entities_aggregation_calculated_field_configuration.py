...
class RelatedEntitiesAggregationCalculatedFieldConfiguration(CalculatedFieldConfiguration):
    """
    ...
    __properties: ClassVar[List[str]] = ["aiGenerated", "output", "type", "relation", "arguments", "deduplicationIntervalInSec", "metrics", "useLatestTs", "scheduledUpdateInterval", "scheduledUpdateEnabled"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RelatedEntitiesAggregationCalculatedFieldConfiguration from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RelatedEntitiesAggregationCalculatedFieldConfiguration from a dict"""
        if obj is None:
            return None
