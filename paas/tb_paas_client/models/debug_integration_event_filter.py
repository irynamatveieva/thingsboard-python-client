...
class DebugIntegrationEventFilter(EventFilter):
    ...
    status_integration: Optional[StrictStr] = Field(default=None, serialization_alias="statusIntegration")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DebugIntegrationEventFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DebugIntegrationEventFilter from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "status_integration": obj.get("statusIntegration")
        })
        return _obj
