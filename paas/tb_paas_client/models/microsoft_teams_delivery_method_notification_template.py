...
class MicrosoftTeamsDeliveryMethodNotificationTemplate(DeliveryMethodNotificationTemplate):
    """
    ...
    __properties: ClassVar[List[str]] = ["enabled", "body", "method", "subject", "themeColor", "button"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MicrosoftTeamsDeliveryMethodNotificationTemplate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MicrosoftTeamsDeliveryMethodNotificationTemplate from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "theme_color": obj.get("themeColor"),
