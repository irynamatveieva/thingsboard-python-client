...
class EmailTwoFaAccountConfig(TwoFaAccountConfig):
    ...
    __properties: ClassVar[List[str]] = ["useByDefault", "providerType", "email"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EmailTwoFaAccountConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EmailTwoFaAccountConfig from a dict"""
        if obj is None:
            return None
