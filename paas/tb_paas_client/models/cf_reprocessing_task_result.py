...
class CfReprocessingTaskResult(TaskResult):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CfReprocessingTaskResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CfReprocessingTaskResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "failure": CfReprocessingTaskFailure.from_dict(obj["failure"]) if obj.get("failure") is not None else None
        })
        return _obj
