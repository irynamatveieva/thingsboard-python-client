...
class SaveDeviceWithCredentialsRequest(BaseModel):
    ...
    credentials: DeviceCredentials = Field(description="The JSON with credentials entity.")
    __properties: ClassVar[List[str]] = ["device", "credentials"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SaveDeviceWithCredentialsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SaveDeviceWithCredentialsRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "credentials": DeviceCredentials.from_dict(obj["credentials"]) if obj.get("credentials") is not None else None
        })
        return _obj
