...
class RichTextComponent(ReportComponent):
    """
    RichTextComponent
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["type", "subType", "dataSources", "margins", "paddings", "background", "borderWidth", "borderRadius", "borderColor", "value"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RichTextComponent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RichTextComponent from a dict"""
        if obj is None:
            return None
