...
class ReportComponent(BaseModel):
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[AlarmTableComponent, DashboardComponent, DividerComponent, EntityTableComponent, ErrorComponent, HeadingComponent, ImageComponent, LatestChartComponent, PageBreakComponent, RichTextComponent, SplitViewComponent, SubReportComponent, TimeseriesChartComponent, TimeseriesTableComponent]]:
        ...
        if object_type ==  'AlarmTableComponent':
            return import_module("tb_paas_client.models.alarm_table_component").AlarmTableComponent.from_dict(obj)
        if object_type ==  'DashboardComponent':
            return import_module("tb_paas_client.models.dashboard_component").DashboardComponent.from_dict(obj)
        if object_type ==  'DividerComponent':
            return import_module("tb_paas_client.models.divider_component").DividerComponent.from_dict(obj)
        if object_type ==  'EntityTableComponent':
            return import_module("tb_paas_client.models.entity_table_component").EntityTableComponent.from_dict(obj)
        if object_type ==  'ErrorComponent':
            return import_module("tb_paas_client.models.error_component").ErrorComponent.from_dict(obj)
        if object_type ==  'HeadingComponent':
            return import_module("tb_paas_client.models.heading_component").HeadingComponent.from_dict(obj)
        if object_type ==  'ImageComponent':
            return import_module("tb_paas_client.models.image_component").ImageComponent.from_dict(obj)
        if object_type ==  'LatestChartComponent':
            return import_module("tb_paas_client.models.latest_chart_component").LatestChartComponent.from_dict(obj)
        if object_type ==  'PageBreakComponent':
            return import_module("tb_paas_client.models.page_break_component").PageBreakComponent.from_dict(obj)
        if object_type ==  'RichTextComponent':
            return import_module("tb_paas_client.models.rich_text_component").RichTextComponent.from_dict(obj)
        if object_type ==  'SplitViewComponent':
            return import_module("tb_paas_client.models.split_view_component").SplitViewComponent.from_dict(obj)
        if object_type ==  'SubReportComponent':
            return import_module("tb_paas_client.models.sub_report_component").SubReportComponent.from_dict(obj)
        if object_type ==  'TimeseriesChartComponent':
            return import_module("tb_paas_client.models.timeseries_chart_component").TimeseriesChartComponent.from_dict(obj)
        if object_type ==  'TimeseriesTableComponent':
            return import_module("tb_paas_client.models.timeseries_table_component").TimeseriesTableComponent.from_dict(obj)
