...
class DeviceTransportConfiguration(BaseModel):
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[CoapDeviceTransportConfiguration, DefaultDeviceTransportConfiguration, Lwm2mDeviceTransportConfiguration, MqttDeviceTransportConfiguration, SnmpDeviceTransportConfiguration]]:
        ...
        if object_type ==  'CoapDeviceTransportConfiguration':
            return import_module("tb_paas_client.models.coap_device_transport_configuration").CoapDeviceTransportConfiguration.from_dict(obj)
        if object_type ==  'DefaultDeviceTransportConfiguration':
            return import_module("tb_paas_client.models.default_device_transport_configuration").DefaultDeviceTransportConfiguration.from_dict(obj)
        if object_type ==  'Lwm2mDeviceTransportConfiguration':
            return import_module("tb_paas_client.models.lwm2m_device_transport_configuration").Lwm2mDeviceTransportConfiguration.from_dict(obj)
        if object_type ==  'MqttDeviceTransportConfiguration':
            return import_module("tb_paas_client.models.mqtt_device_transport_configuration").MqttDeviceTransportConfiguration.from_dict(obj)
        if object_type ==  'SnmpDeviceTransportConfiguration':
            return import_module("tb_paas_client.models.snmp_device_transport_configuration").SnmpDeviceTransportConfiguration.from_dict(obj)
