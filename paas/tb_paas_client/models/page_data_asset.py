...
class PageDataAsset(BaseModel):
    ...
    PageDataAsset
    """ # noqa: E501
    data: Optional[List[Asset]] = Field(default=None, description="Array of the entities")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageDataAsset from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageDataAsset from a dict"""
        if obj is None:
            return None
