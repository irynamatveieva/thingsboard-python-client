...
`tb_paas_client.models.PageDataAssetInfo`

## Properties

| Name | Type | Description | Notes |
|------------ | ------------- | ------------- | -------------|
| **data** | [**List[AssetInfo]**](AssetInfo.md) | Array of the entities | [optional] |
...
- **Deserialize:** `PageDataAssetInfo.model_validate(data)` or `PageDataAssetInfo.model_validate_json(json_str)`
