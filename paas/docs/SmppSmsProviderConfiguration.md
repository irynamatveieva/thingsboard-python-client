...
`tb_paas_client.models.SmppSmsProviderConfiguration`
...
| **bind_type** | [**SmppBindType**](SmppBindType.md) | TX - Transmitter, RX - Receiver, TRX - Transciever. By default TX is used | [optional] |
...
- **Attribute access:** `obj.protocol_version`, `obj.name`, etc.
- **Serialize:** `obj.model_dump()` or `obj.model_dump(by_alias=True)` for camelCase JSON
- **Deserialize:** `SmppSmsProviderConfiguration.model_validate(data)` or `SmppSmsProviderConfiguration.model_validate_json(json_str)`
