...
`tb_paas_client.models.PageDataScheduledReportInfo`

## Properties

| Name | Type | Description | Notes |
|------------ | ------------- | ------------- | -------------|
| **data** | [**List[ScheduledReportInfo]**](ScheduledReportInfo.md) | Array of the entities | [optional] |
...
| template_info | EntityInfo | Report template info | [optional] [readonly] |
...
- **Deserialize:** `PageDataScheduledReportInfo.model_validate(data)` or `PageDataScheduledReportInfo.model_validate_json(json_str)`
