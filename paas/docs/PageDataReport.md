...
`tb_paas_client.models.PageDataReport`

## Properties

| Name | Type | Description | Notes |
|------------ | ------------- | ------------- | -------------|
| **data** | [**List[Report]**](Report.md) | Array of the entities | [optional] |
...
- **Deserialize:** `PageDataReport.model_validate(data)` or `PageDataReport.model_validate_json(json_str)`
