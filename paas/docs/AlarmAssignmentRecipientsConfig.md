...
`tb_paas_client.models.AlarmAssignmentRecipientsConfig`
...
- **Deserialize:** `AlarmAssignmentRecipientsConfig.model_validate(data)` or `AlarmAssignmentRecipientsConfig.model_validate_json(json_str)`
