...
`tb_paas_client.models.PageDataCalculatedField`

## Properties

| Name | Type | Description | Notes |
|------------ | ------------- | ------------- | -------------|
| **data** | [**List[CalculatedField]**](CalculatedField.md) | Array of the entities | [optional] |
...
- **Deserialize:** `PageDataCalculatedField.model_validate(data)` or `PageDataCalculatedField.model_validate_json(json_str)`
