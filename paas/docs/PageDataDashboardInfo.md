...
`tb_paas_client.models.PageDataDashboardInfo`
...
> **EntityId types** (`CustomerId`, `DashboardId`, `TenantId`, etc.): `{entity_type: EntityType, id: UUID}` — all EntityId subtypes share this structure.
