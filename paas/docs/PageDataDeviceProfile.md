...
`tb_paas_client.models.PageDataDeviceProfile`

## Properties

| Name | Type | Description | Notes |
|------------ | ------------- | ------------- | -------------|
| **data** | [**List[DeviceProfile]**](DeviceProfile.md) | Array of the entities | [optional] |
...
| provision_type | DeviceProfileProvisionType | Provisioning strategy. | [optional] |
...
- **Deserialize:** `PageDataDeviceProfile.model_validate(data)` or `PageDataDeviceProfile.model_validate_json(json_str)`
