...
`tb_paas_client.models.SaveOtaPackageInfoRequest`
...
- **Deserialize:** `SaveOtaPackageInfoRequest.model_validate(data)` or `SaveOtaPackageInfoRequest.model_validate_json(json_str)`
