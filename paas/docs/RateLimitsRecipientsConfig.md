...
`tb_paas_client.models.RateLimitsRecipientsConfig`
...
- **Deserialize:** `RateLimitsRecipientsConfig.model_validate(data)` or `RateLimitsRecipientsConfig.model_validate_json(json_str)`
