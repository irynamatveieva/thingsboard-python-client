...
> **EntityId types** (`EntityGroupId`, `GroupPermissionId`, `MobileAppBundleId`, `MobileAppId`, `NotificationTargetId`, `OAuth2ClientId`, `RoleId`, `TenantId`, etc.): `{entity_type: EntityType, id: UUID}` — all EntityId subtypes share this structure.
