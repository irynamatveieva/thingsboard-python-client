...
`tb_paas_client.models.ReportTemplateExportData`
...
- **Deserialize:** `ReportTemplateExportData.model_validate(data)` or `ReportTemplateExportData.model_validate_json(json_str)`
