...
`tb_paas_client.models.TaskProcessingFailureRecipientsConfig`
...
- **Deserialize:** `TaskProcessingFailureRecipientsConfig.model_validate(data)` or `TaskProcessingFailureRecipientsConfig.model_validate_json(json_str)`
