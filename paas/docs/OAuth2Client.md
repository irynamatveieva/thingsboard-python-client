...
`tb_paas_client.models.OAuth2Client`
...
> **EntityId types** (`CustomerId`, `OAuth2ClientId`, `TenantId`, etc.): `{entity_type: EntityType, id: UUID}` — all EntityId subtypes share this structure.
