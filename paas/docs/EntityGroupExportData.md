...
`tb_paas_client.models.EntityGroupExportData`
...
> **EntityId types** (`CalculatedFieldId`, `EntityGroupId`, `GroupPermissionId`, `OtaPackageId`, `RoleId`, `TenantId`, etc.): `{entity_type: EntityType, id: UUID}` — all EntityId subtypes share this structure.
