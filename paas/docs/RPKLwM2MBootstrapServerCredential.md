...
`tb_paas_client.models.RPKLwM2MBootstrapServerCredential`
...
- **Deserialize:** `RPKLwM2MBootstrapServerCredential.model_validate(data)` or `RPKLwM2MBootstrapServerCredential.model_validate_json(json_str)`
