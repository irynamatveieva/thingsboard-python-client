...
`tb_paas_client.models.PageDataDomainInfo`

## Properties

| Name | Type | Description | Notes |
|------------ | ------------- | ------------- | -------------|
| **data** | [**List[DomainInfo]**](DomainInfo.md) | Array of the entities | [optional] |
...
- **Deserialize:** `PageDataDomainInfo.model_validate(data)` or `PageDataDomainInfo.model_validate_json(json_str)`
