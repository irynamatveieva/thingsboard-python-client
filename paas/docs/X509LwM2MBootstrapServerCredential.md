...
`tb_paas_client.models.X509LwM2MBootstrapServerCredential`
...
- **Deserialize:** `X509LwM2MBootstrapServerCredential.model_validate(data)` or `X509LwM2MBootstrapServerCredential.model_validate_json(json_str)`
