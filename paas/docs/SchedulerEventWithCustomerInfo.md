...
`tb_paas_client.models.SchedulerEventWithCustomerInfo`
...
- **Deserialize:** `SchedulerEventWithCustomerInfo.model_validate(data)` or `SchedulerEventWithCustomerInfo.model_validate_json(json_str)`
