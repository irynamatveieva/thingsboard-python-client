...
`tb_paas_client.models.CsvReportTemplateConfig`
...
- **Deserialize:** `CsvReportTemplateConfig.model_validate(data)` or `CsvReportTemplateConfig.model_validate_json(json_str)`
