...
`tb_paas_client.models.EdgeEventType`
...
* `RULE_CHAIN_METADATA` (value: `'RULE_CHAIN_METADATA'`)
...
- **Deserialize:** `EdgeEventType.model_validate(data)` or `EdgeEventType.model_validate_json(json_str)`
