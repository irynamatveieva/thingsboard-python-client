...
`tb_paas_client.models.PageDataTenant`

## Properties

| Name | Type | Description | Notes |
|------------ | ------------- | ------------- | -------------|
| **data** | [**List[Tenant]**](Tenant.md) | Array of the entities | [optional] |
...
- **Deserialize:** `PageDataTenant.model_validate(data)` or `PageDataTenant.model_validate_json(json_str)`
