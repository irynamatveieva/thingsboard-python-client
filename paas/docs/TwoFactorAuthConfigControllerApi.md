...
```python
AccountTwoFaSettings client.delete_two_fa_account_config(provider_type: TwoFaProviderType)  # Delete 2FA account config (deleteTwoFaAccountConfig)
TwoFaAccountConfig client.generate_two_fa_account_config(provider_type: str)  # Generate 2FA account config (generateTwoFaAccountConfig)
AccountTwoFaSettings client.get_account_two_fa_settings()  # Get account 2FA settings (getAccountTwoFaSettings)
List[TwoFaProviderType] client.get_available_two_fa_provider_types()  # Get available 2FA providers (getAvailableTwoFaProviderTypes)
PlatformTwoFaSettings client.get_platform_two_fa_settings()  # Get platform 2FA settings (getPlatformTwoFaSettings)
PlatformTwoFaSettings client.save_platform_two_fa_settings(platform_two_fa_settings: PlatformTwoFaSettings)  # Save platform 2FA settings (savePlatformTwoFaSettings)
None client.submit_two_fa_account_config(two_fa_account_config: TwoFaAccountConfig)  # Submit 2FA account config (submitTwoFaAccountConfig)
AccountTwoFaSettings client.update_two_fa_account_config(provider_type: TwoFaProviderType, two_fa_account_config_update_request: TwoFaAccountConfigUpdateRequest)  # Update 2FA account config (updateTwoFaAccountConfig)
AccountTwoFaSettings client.verify_and_save_two_fa_account_config(two_fa_account_config: TwoFaAccountConfig, verification_code: Optional[str] = None)  # Verify and save 2FA account config (verifyAndSaveTwoFaAccountConfig)
```


## delete_two_fa_account_config

```python
AccountTwoFaSettings client.delete_two_fa_account_config(provider_type: TwoFaProviderType)
```
...
```python
TwoFaAccountConfig client.generate_two_fa_account_config(provider_type: str)
```
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **provider_type** | **str** | 2FA provider type to generate new account config for | |
...
## get_account_two_fa_settings

```python
AccountTwoFaSettings client.get_account_two_fa_settings()
```
...
## get_available_two_fa_provider_types

```python
List[TwoFaProviderType] client.get_available_two_fa_provider_types()
```
...
## get_platform_two_fa_settings

```python
PlatformTwoFaSettings client.get_platform_two_fa_settings()
```
...
```python
PlatformTwoFaSettings client.save_platform_two_fa_settings(platform_two_fa_settings: PlatformTwoFaSettings)
```
...
## submit_two_fa_account_config

```python
None client.submit_two_fa_account_config(two_fa_account_config: TwoFaAccountConfig)
```
...
## update_two_fa_account_config

```python
AccountTwoFaSettings client.update_two_fa_account_config(provider_type: TwoFaProviderType, two_fa_account_config_update_request: TwoFaAccountConfigUpdateRequest)
```
...
## verify_and_save_two_fa_account_config

```python
AccountTwoFaSettings client.verify_and_save_two_fa_account_config(two_fa_account_config: TwoFaAccountConfig, verification_code: Optional[str] = None)
```
