...
`tb_paas_client.models.EdgeCommunicationFailureRecipientsConfig`
...
- **Deserialize:** `EdgeCommunicationFailureRecipientsConfig.model_validate(data)` or `EdgeCommunicationFailureRecipientsConfig.model_validate_json(json_str)`
