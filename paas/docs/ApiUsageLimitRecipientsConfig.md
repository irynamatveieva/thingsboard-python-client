...
`tb_paas_client.models.ApiUsageLimitRecipientsConfig`
...
- **Deserialize:** `ApiUsageLimitRecipientsConfig.model_validate(data)` or `ApiUsageLimitRecipientsConfig.model_validate_json(json_str)`
