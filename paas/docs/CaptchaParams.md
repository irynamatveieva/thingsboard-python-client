...
`tb_paas_client.models.CaptchaParams`
...
#### EnterpriseCaptchaParams  *(version=`enterprise`)*
| Name | Type | Description | Notes |
|------|------|-------------|-------|
...
- **Deserialize:** `CaptchaParams.model_validate(data)` or `CaptchaParams.model_validate_json(json_str)`
