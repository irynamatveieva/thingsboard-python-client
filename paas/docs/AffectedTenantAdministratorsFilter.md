...
`tb_paas_client.models.AffectedTenantAdministratorsFilter`
...
- **Deserialize:** `AffectedTenantAdministratorsFilter.model_validate(data)` or `AffectedTenantAdministratorsFilter.model_validate_json(json_str)`
