...
`tb_paas_client.models.PageDataCustomer`

## Properties

| Name | Type | Description | Notes |
|------------ | ------------- | ------------- | -------------|
| **data** | [**List[Customer]**](Customer.md) | Array of the entities | [optional] |
...
- **Deserialize:** `PageDataCustomer.model_validate(data)` or `PageDataCustomer.model_validate_json(json_str)`
