...
`tb_paas_client.models.TenantProfileConfiguration`
...
#### DefaultTenantProfileConfiguration  *(type=`DEFAULT`)*
| Name | Type | Description | Notes |
|------|------|-------------|-------|
...
- **Deserialize:** `TenantProfileConfiguration.model_validate(data)` or `TenantProfileConfiguration.model_validate_json(json_str)`
