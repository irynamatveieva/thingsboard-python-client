...
None client.send_addon_access_request(addon_type: str)  # Send add-on access request notification to System/Tenant administrators (sendAddonAccessRequest)
...
None client.send_plan_upgrade_request(plan_name: str)  # Send plan upgrade request notification to Tenant administrators (sendPlanUpgradeRequest)
```
...
## send_addon_access_request

```python
None client.send_addon_access_request(addon_type: str)
```
...
## send_plan_upgrade_request

```python
None client.send_plan_upgrade_request(plan_name: str)
```
