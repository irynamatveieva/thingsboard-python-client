...
`tb_paas_client.models.TimeseriesChartComponent`
...
| **time_series_chart_settings** | [**ReportTimeSeriesChartSettings**](ReportTimeSeriesChartSettings.md) |  | [optional] |
...
- **Deserialize:** `TimeseriesChartComponent.model_validate(data)` or `TimeseriesChartComponent.model_validate_json(json_str)`
