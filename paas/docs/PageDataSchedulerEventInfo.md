...
`tb_paas_client.models.PageDataSchedulerEventInfo`

## Properties

| Name | Type | Description | Notes |
|------------ | ------------- | ------------- | -------------|
| **data** | [**List[SchedulerEventInfo]**](SchedulerEventInfo.md) | Array of the entities | [optional] |
...
- **Deserialize:** `PageDataSchedulerEventInfo.model_validate(data)` or `PageDataSchedulerEventInfo.model_validate_json(json_str)`
