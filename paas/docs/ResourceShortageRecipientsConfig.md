...
`tb_paas_client.models.ResourceShortageRecipientsConfig`
...
- **Deserialize:** `ResourceShortageRecipientsConfig.model_validate(data)` or `ResourceShortageRecipientsConfig.model_validate_json(json_str)`
