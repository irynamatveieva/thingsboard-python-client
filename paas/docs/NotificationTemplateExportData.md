...
`tb_paas_client.models.NotificationTemplateExportData`
...
- **Deserialize:** `NotificationTemplateExportData.model_validate(data)` or `NotificationTemplateExportData.model_validate_json(json_str)`
