...
`tb_paas_client.models.ImageComponent`
...
| **source_type** | [**ImageSourceType**](ImageSourceType.md) |  | [optional] |
...
- **Deserialize:** `ImageComponent.model_validate(data)` or `ImageComponent.model_validate_json(json_str)`
