...
`tb_paas_client.models.PSKLwM2MBootstrapServerCredential`
...
- **Deserialize:** `PSKLwM2MBootstrapServerCredential.model_validate(data)` or `PSKLwM2MBootstrapServerCredential.model_validate_json(json_str)`
