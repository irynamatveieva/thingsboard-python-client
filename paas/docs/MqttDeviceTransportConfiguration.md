...
`tb_paas_client.models.MqttDeviceTransportConfiguration`
...
- **Deserialize:** `MqttDeviceTransportConfiguration.model_validate(data)` or `MqttDeviceTransportConfiguration.model_validate_json(json_str)`
