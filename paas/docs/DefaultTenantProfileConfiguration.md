...
`tb_paas_client.models.DefaultTenantProfileConfiguration`

**Extends:** **TenantProfileConfiguration**
...
- **Deserialize:** `DefaultTenantProfileConfiguration.model_validate(data)` or `DefaultTenantProfileConfiguration.model_validate_json(json_str)`
