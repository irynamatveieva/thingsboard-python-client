...
`tb_paas_client.models.NoSecLwM2MBootstrapServerCredential`
...
- **Deserialize:** `NoSecLwM2MBootstrapServerCredential.model_validate(data)` or `NoSecLwM2MBootstrapServerCredential.model_validate_json(json_str)`
