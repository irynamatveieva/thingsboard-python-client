...
`tb_paas_client.models.SmsProviderConfiguration`
...
#### AwsSnsSmsProviderConfiguration  *(type=`AWS_SNS`)*
| Name | Type | Description | Notes |
|------|------|-------------|-------|
...
#### SmppSmsProviderConfiguration  *(type=`SMPP`)*
| Name | Type | Description | Notes |
|------|------|-------------|-------|
...
#### TwilioSmsProviderConfiguration  *(type=`TWILIO`)*
| Name | Type | Description | Notes |
|------|------|-------------|-------|
...
- **Deserialize:** `SmsProviderConfiguration.model_validate(data)` or `SmsProviderConfiguration.model_validate_json(json_str)`
