...
`tb_paas_client.models.LwM2MServerSecurityConfigDefault`
...
| **security_host** | **str** | Host for 'Security' mode (DTLS) | [optional] [readonly] |
| **security_port** | **int** | Port for 'Security' mode (DTLS): Lwm2m Server or Bootstrap Server | [optional] [readonly] |
...
- **Attribute access:** `obj.short_server_id`, `obj.name`, etc.
- **Serialize:** `obj.model_dump()` or `obj.model_dump(by_alias=True)` for camelCase JSON
- **Deserialize:** `LwM2MServerSecurityConfigDefault.model_validate(data)` or `LwM2MServerSecurityConfigDefault.model_validate_json(json_str)`
