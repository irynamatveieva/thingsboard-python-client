...
`tb_paas_client.models.RuleEngineComponentLifecycleEventRecipientsConfig`
...
- **Deserialize:** `RuleEngineComponentLifecycleEventRecipientsConfig.model_validate(data)` or `RuleEngineComponentLifecycleEventRecipientsConfig.model_validate_json(json_str)`
