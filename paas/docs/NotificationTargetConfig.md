...
`tb_paas_client.models.NotificationTargetConfig`
...
#### MicrosoftTeamsNotificationTargetConfig  *(type=`MICROSOFT_TEAMS`)*
| Name | Type | Description | Notes |
|------|------|-------------|-------|
| webhook_url | str |  |  |
| channel_name | str |  |  |
...
#### PlatformUsersNotificationTargetConfig  *(type=`PLATFORM_USERS`)*
| Name | Type | Description | Notes |
|------|------|-------------|-------|
| users_filter | UsersFilter |  |  |

#### SlackNotificationTargetConfig  *(type=`SLACK`)*
| Name | Type | Description | Notes |
|------|------|-------------|-------|
...
- **Attribute access:** `obj.description`, `obj.name`, etc.
- **Serialize:** `obj.model_dump()` or `obj.model_dump(by_alias=True)` for camelCase JSON
- **Deserialize:** `NotificationTargetConfig.model_validate(data)` or `NotificationTargetConfig.model_validate_json(json_str)`
