...
`tb_paas_client.models.IntegrationExportData`
...
- **Deserialize:** `IntegrationExportData.model_validate(data)` or `IntegrationExportData.model_validate_json(json_str)`
