...
> **EntityId types** (`CustomerId`, `EntityGroupId`, `GroupPermissionId`, `RoleId`, `TenantId`, etc.): `{entity_type: EntityType, id: UUID}` — all EntityId subtypes share this structure.
