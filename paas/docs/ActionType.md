...
`tb_paas_client.models.ActionType`
...
* `ADDED_TO_ENTITY_GROUP` (value: `'ADDED_TO_ENTITY_GROUP'`)

* `REMOVED_FROM_ENTITY_GROUP` (value: `'REMOVED_FROM_ENTITY_GROUP'`)

* `REST_API_RULE_ENGINE_CALL` (value: `'REST_API_RULE_ENGINE_CALL'`)

* `MADE_PUBLIC` (value: `'MADE_PUBLIC'`)

* `MADE_PRIVATE` (value: `'MADE_PRIVATE'`)
...
* `SUBSCRIPTION_PLAN_UPDATED` (value: `'SUBSCRIPTION_PLAN_UPDATED'`)

* `SUBSCRIPTION_COUPON_APPLIED` (value: `'SUBSCRIPTION_COUPON_APPLIED'`)
...
- **Deserialize:** `ActionType.model_validate(data)` or `ActionType.model_validate_json(json_str)`
