...
class UserMobileInfo(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserMobileInfo from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of home_dashboard_info
        if self.home_dashboard_info:
            _dict['homeDashboardInfo'] = self.home_dashboard_info.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserMobileInfo from a dict"""
        if obj is None:
            return None
