...
class TenantProfileData(BaseModel):
    ...
    queue_configuration: Optional[List[TenantProfileQueueConfiguration]] = Field(default=None, description="JSON array of queue configuration per tenant profile", serialization_alias="queueConfiguration")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "queue_configuration": [TenantProfileQueueConfiguration.from_dict(_item) for _item in obj["queueConfiguration"]] if obj.get("queueConfiguration") is not None else None
        })
        return _obj
