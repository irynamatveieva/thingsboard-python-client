...
class CalculatedField(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "createdTime", "tenantId", "entityId", "type", "name", "debugSettings", "configurationVersion", "configuration", "version", "additionalInfo", "debugMode"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CalculatedField from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CalculatedField from a dict"""
        if obj is None:
            return None
