...
class TimeSeriesOutput(Output):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TimeSeriesOutput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TimeSeriesOutput from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "strategy": TimeSeriesOutputStrategy.from_dict(obj["strategy"]) if obj.get("strategy") is not None else None,
            "type": obj.get("type")
        })
        return _obj
