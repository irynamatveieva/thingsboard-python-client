...
class EntityId(BaseModel):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'ADMIN_SETTINGS': 'AdminSettingsId','AI_MODEL': 'AiModelId','ALARM': 'AlarmId','API_KEY': 'ApiKeyId','API_USAGE_STATE': 'ApiUsageStateId','ASSET': 'AssetId','ASSET_PROFILE': 'AssetProfileId','CALCULATED_FIELD': 'CalculatedFieldId','CUSTOMER': 'CustomerId','DASHBOARD': 'DashboardId','DEVICE': 'DeviceId','DEVICE_PROFILE': 'DeviceProfileId','DOMAIN': 'DomainId','EDGE': 'EdgeId','ENTITY_VIEW': 'EntityViewId','JOB': 'JobId','MOBILE_APP': 'MobileAppId','MOBILE_APP_BUNDLE': 'MobileAppBundleId','NOTIFICATION': 'NotificationId','NOTIFICATION_REQUEST': 'NotificationRequestId','NOTIFICATION_RULE': 'NotificationRuleId','NOTIFICATION_TARGET': 'NotificationTargetId','NOTIFICATION_TEMPLATE': 'NotificationTemplateId','OAUTH2_CLIENT': 'OAuth2ClientId','OTA_PACKAGE': 'OtaPackageId','QUEUE': 'QueueId','QUEUE_STATS': 'QueueStatsId','RPC': 'RpcId','RULE_CHAIN': 'RuleChainId','RULE_NODE': 'RuleNodeId','TB_RESOURCE': 'TbResourceId','TENANT': 'TenantId','TENANT_PROFILE': 'TenantProfileId','USER': 'UserId','WIDGETS_BUNDLE': 'WidgetsBundleId','WIDGET_TYPE': 'WidgetTypeId'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[AdminSettingsId, AiModelId, AlarmId, ApiKeyId, ApiUsageStateId, AssetId, AssetProfileId, CalculatedFieldId, CustomerId, DashboardId, DeviceId, DeviceProfileId, DomainId, EdgeId, EntityViewId, JobId, MobileAppId, MobileAppBundleId, NotificationId, NotificationRequestId, NotificationRuleId, NotificationTargetId, NotificationTemplateId, OAuth2ClientId, OtaPackageId, QueueId, QueueStatsId, RpcId, RuleChainId, RuleNodeId, TbResourceId, TenantId, TenantProfileId, UserId, WidgetsBundleId, WidgetTypeId]]:
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[AdminSettingsId, AiModelId, AlarmId, ApiKeyId, ApiUsageStateId, AssetId, AssetProfileId, CalculatedFieldId, CustomerId, DashboardId, DeviceId, DeviceProfileId, DomainId, EdgeId, EntityViewId, JobId, MobileAppId, MobileAppBundleId, NotificationId, NotificationRequestId, NotificationRuleId, NotificationTargetId, NotificationTemplateId, OAuth2ClientId, OtaPackageId, QueueId, QueueStatsId, RpcId, RuleChainId, RuleNodeId, TbResourceId, TenantId, TenantProfileId, UserId, WidgetsBundleId, WidgetTypeId]]:
        ...
        if object_type ==  'AdminSettingsId':
            return import_module("tb_ce_client.models.admin_settings_id").AdminSettingsId.from_dict(obj)
        if object_type ==  'AiModelId':
            return import_module("tb_ce_client.models.ai_model_id").AiModelId.from_dict(obj)
        if object_type ==  'AlarmId':
            return import_module("tb_ce_client.models.alarm_id").AlarmId.from_dict(obj)
        if object_type ==  'ApiKeyId':
            return import_module("tb_ce_client.models.api_key_id").ApiKeyId.from_dict(obj)
        if object_type ==  'ApiUsageStateId':
            return import_module("tb_ce_client.models.api_usage_state_id").ApiUsageStateId.from_dict(obj)
        if object_type ==  'AssetId':
            return import_module("tb_ce_client.models.asset_id").AssetId.from_dict(obj)
        if object_type ==  'AssetProfileId':
            return import_module("tb_ce_client.models.asset_profile_id").AssetProfileId.from_dict(obj)
        if object_type ==  'CalculatedFieldId':
            return import_module("tb_ce_client.models.calculated_field_id").CalculatedFieldId.from_dict(obj)
        if object_type ==  'CustomerId':
            return import_module("tb_ce_client.models.customer_id").CustomerId.from_dict(obj)
        if object_type ==  'DashboardId':
            return import_module("tb_ce_client.models.dashboard_id").DashboardId.from_dict(obj)
        if object_type ==  'DeviceId':
            return import_module("tb_ce_client.models.device_id").DeviceId.from_dict(obj)
        if object_type ==  'DeviceProfileId':
            return import_module("tb_ce_client.models.device_profile_id").DeviceProfileId.from_dict(obj)
        if object_type ==  'DomainId':
            return import_module("tb_ce_client.models.domain_id").DomainId.from_dict(obj)
        if object_type ==  'EdgeId':
            return import_module("tb_ce_client.models.edge_id").EdgeId.from_dict(obj)
        if object_type ==  'EntityViewId':
            return import_module("tb_ce_client.models.entity_view_id").EntityViewId.from_dict(obj)
        if object_type ==  'JobId':
            return import_module("tb_ce_client.models.job_id").JobId.from_dict(obj)
        if object_type ==  'MobileAppId':
            return import_module("tb_ce_client.models.mobile_app_id").MobileAppId.from_dict(obj)
        if object_type ==  'MobileAppBundleId':
            return import_module("tb_ce_client.models.mobile_app_bundle_id").MobileAppBundleId.from_dict(obj)
        if object_type ==  'NotificationId':
            return import_module("tb_ce_client.models.notification_id").NotificationId.from_dict(obj)
        if object_type ==  'NotificationRequestId':
            return import_module("tb_ce_client.models.notification_request_id").NotificationRequestId.from_dict(obj)
        if object_type ==  'NotificationRuleId':
            return import_module("tb_ce_client.models.notification_rule_id").NotificationRuleId.from_dict(obj)
        if object_type ==  'NotificationTargetId':
            return import_module("tb_ce_client.models.notification_target_id").NotificationTargetId.from_dict(obj)
        if object_type ==  'NotificationTemplateId':
            return import_module("tb_ce_client.models.notification_template_id").NotificationTemplateId.from_dict(obj)
        if object_type ==  'OAuth2ClientId':
            return import_module("tb_ce_client.models.o_auth2_client_id").OAuth2ClientId.from_dict(obj)
        if object_type ==  'OtaPackageId':
            return import_module("tb_ce_client.models.ota_package_id").OtaPackageId.from_dict(obj)
        if object_type ==  'QueueId':
            return import_module("tb_ce_client.models.queue_id").QueueId.from_dict(obj)
        if object_type ==  'QueueStatsId':
            return import_module("tb_ce_client.models.queue_stats_id").QueueStatsId.from_dict(obj)
        if object_type ==  'RpcId':
            return import_module("tb_ce_client.models.rpc_id").RpcId.from_dict(obj)
        if object_type ==  'RuleChainId':
            return import_module("tb_ce_client.models.rule_chain_id").RuleChainId.from_dict(obj)
        if object_type ==  'RuleNodeId':
            return import_module("tb_ce_client.models.rule_node_id").RuleNodeId.from_dict(obj)
        if object_type ==  'TbResourceId':
            return import_module("tb_ce_client.models.tb_resource_id").TbResourceId.from_dict(obj)
        if object_type ==  'TenantId':
            return import_module("tb_ce_client.models.tenant_id").TenantId.from_dict(obj)
        if object_type ==  'TenantProfileId':
            return import_module("tb_ce_client.models.tenant_profile_id").TenantProfileId.from_dict(obj)
        if object_type ==  'UserId':
            return import_module("tb_ce_client.models.user_id").UserId.from_dict(obj)
        if object_type ==  'WidgetsBundleId':
            return import_module("tb_ce_client.models.widgets_bundle_id").WidgetsBundleId.from_dict(obj)
        if object_type ==  'WidgetTypeId':
            return import_module("tb_ce_client.models.widget_type_id").WidgetTypeId.from_dict(obj)
