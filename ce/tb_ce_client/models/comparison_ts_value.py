...
class ComparisonTsValue(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["current", "previous"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ComparisonTsValue from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ComparisonTsValue from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "current": TsValue.from_dict(obj["current"]) if obj.get("current") is not None else None,
            "previous": TsValue.from_dict(obj["previous"]) if obj.get("previous") is not None else None
        })
        return _obj
