...
class OpenAiChatModelConfig(AiModelConfig):
    """
    OpenAiChatModelConfig
    """ # noqa: E501
    provider_config: OpenAiProviderConfig = Field(serialization_alias="providerConfig")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OpenAiChatModelConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OpenAiChatModelConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "provider_config": OpenAiProviderConfig.from_dict(obj["providerConfig"]) if obj.get("providerConfig") is not None else None,
