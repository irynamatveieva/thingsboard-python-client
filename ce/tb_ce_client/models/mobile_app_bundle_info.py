...
class MobileAppBundleInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "createdTime", "tenantId", "title", "description", "androidAppId", "iosAppId", "layoutConfig", "oauth2Enabled", "androidPkgName", "iosPkgName", "oauth2ClientInfos", "qrCodeEnabled", "name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MobileAppBundleInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MobileAppBundleInfo from a dict"""
        if obj is None:
            return None
