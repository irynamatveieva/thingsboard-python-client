...
class AzureOpenAiChatModelConfig(AiModelConfig):
    ...
    provider_config: AzureOpenAiProviderConfig = Field(alias="providerConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "providerConfig": AzureOpenAiProviderConfig.from_dict(obj["providerConfig"]) if obj.get("providerConfig") is not None else None,
