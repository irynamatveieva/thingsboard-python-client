...
class AzureOpenAiChatModelConfig(AiModelConfig):
    """
    AzureOpenAiChatModelConfig
    """ # noqa: E501
    provider_config: AzureOpenAiProviderConfig = Field(serialization_alias="providerConfig")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AzureOpenAiChatModelConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AzureOpenAiChatModelConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "provider_config": AzureOpenAiProviderConfig.from_dict(obj["providerConfig"]) if obj.get("providerConfig") is not None else None,
