...
class JobResult(BaseModel):
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[DummyJobResult]]:
        """Create an instance of JobResult from a dict"""
        # look up the object type based on discriminator mapping
        object_type = cls.get_discriminator_value(obj)
        if object_type ==  'DummyJobResult':
            return import_module("tb_ce_client.models.dummy_job_result").DummyJobResult.from_dict(obj)
