...
class EntityViewInfo(BaseModel):
    ...
    customer_title: Optional[StrictStr] = Field(default=None, description="Title of the Customer that owns the entity view.", alias="customerTitle")
    customer_is_public: Optional[StrictBool] = Field(default=None, description="Indicates special 'Public' Customer that is auto-generated to use the entity view on public dashboards.", alias="customerIsPublic")
