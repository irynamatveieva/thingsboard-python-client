...
class DeviceSearchQuery(BaseModel):
    ...
    device_types: Optional[List[StrictStr]] = Field(default=None, description="Array of device types to filter the related entities (e.g. 'Temperature Sensor', 'Smoke Sensor').", serialization_alias="deviceTypes")
    __properties: ClassVar[List[str]] = ["parameters", "relationType", "deviceTypes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeviceSearchQuery from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeviceSearchQuery from a dict"""
        if obj is None:
            return None
