...
class EntityFilter(BaseModel):
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'apiUsageState': 'ApiUsageStateFilter','assetSearchQuery': 'AssetSearchQueryFilter','assetType': 'AssetTypeFilter','deviceSearchQuery': 'DeviceSearchQueryFilter','deviceType': 'DeviceTypeFilter','edgeSearchQuery': 'EdgeSearchQueryFilter','edgeType': 'EdgeTypeFilter','entityList': 'EntityListFilter','entityName': 'EntityNameFilter','entityType': 'EntityTypeFilter','entityViewSearchQuery': 'EntityViewSearchQueryFilter','entityViewType': 'EntityViewTypeFilter','relationsQuery': 'RelationsQueryFilter','singleEntity': 'SingleEntityFilter'
    }
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[ApiUsageStateFilter, AssetSearchQueryFilter, AssetTypeFilter, DeviceSearchQueryFilter, DeviceTypeFilter, EdgeSearchQueryFilter, EdgeTypeFilter, EntityListFilter, EntityNameFilter, EntityTypeFilter, EntityViewSearchQueryFilter, EntityViewTypeFilter, RelationsQueryFilter, SingleEntityFilter]]:
        ...
        if object_type ==  'ApiUsageStateFilter':
            return import_module("tb_ce_client.models.api_usage_state_filter").ApiUsageStateFilter.from_dict(obj)
        if object_type ==  'AssetSearchQueryFilter':
            return import_module("tb_ce_client.models.asset_search_query_filter").AssetSearchQueryFilter.from_dict(obj)
        if object_type ==  'AssetTypeFilter':
            return import_module("tb_ce_client.models.asset_type_filter").AssetTypeFilter.from_dict(obj)
        if object_type ==  'DeviceSearchQueryFilter':
            return import_module("tb_ce_client.models.device_search_query_filter").DeviceSearchQueryFilter.from_dict(obj)
        if object_type ==  'DeviceTypeFilter':
            return import_module("tb_ce_client.models.device_type_filter").DeviceTypeFilter.from_dict(obj)
        if object_type ==  'EdgeSearchQueryFilter':
            return import_module("tb_ce_client.models.edge_search_query_filter").EdgeSearchQueryFilter.from_dict(obj)
        if object_type ==  'EdgeTypeFilter':
            return import_module("tb_ce_client.models.edge_type_filter").EdgeTypeFilter.from_dict(obj)
        if object_type ==  'EntityListFilter':
            return import_module("tb_ce_client.models.entity_list_filter").EntityListFilter.from_dict(obj)
        if object_type ==  'EntityNameFilter':
            return import_module("tb_ce_client.models.entity_name_filter").EntityNameFilter.from_dict(obj)
        if object_type ==  'EntityTypeFilter':
            return import_module("tb_ce_client.models.entity_type_filter").EntityTypeFilter.from_dict(obj)
        if object_type ==  'EntityViewSearchQueryFilter':
            return import_module("tb_ce_client.models.entity_view_search_query_filter").EntityViewSearchQueryFilter.from_dict(obj)
        if object_type ==  'EntityViewTypeFilter':
            return import_module("tb_ce_client.models.entity_view_type_filter").EntityViewTypeFilter.from_dict(obj)
        if object_type ==  'RelationsQueryFilter':
            return import_module("tb_ce_client.models.relations_query_filter").RelationsQueryFilter.from_dict(obj)
        if object_type ==  'SingleEntityFilter':
            return import_module("tb_ce_client.models.single_entity_filter").SingleEntityFilter.from_dict(obj)
