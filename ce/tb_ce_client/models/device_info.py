...
class DeviceInfo(BaseModel):
    ...
    customer_title: Optional[StrictStr] = Field(default=None, description="Title of the Customer that owns the device.", serialization_alias="customerTitle")
    customer_is_public: Optional[StrictBool] = Field(default=None, description="Indicates special 'Public' Customer that is auto-generated to use the devices on public dashboards.", serialization_alias="customerIsPublic")
    device_profile_name: Optional[StrictStr] = Field(default=None, description="Name of the corresponding Device Profile.", serialization_alias="deviceProfileName")
    active: Optional[StrictBool] = Field(default=None, description="Device active flag.")
    __properties: ClassVar[List[str]] = ["id", "createdTime", "additionalInfo", "tenantId", "customerId", "name", "type", "label", "deviceProfileId", "deviceData", "firmwareId", "softwareId", "version", "customerTitle", "customerIsPublic", "deviceProfileName", "active"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "device_profile_name": obj.get("deviceProfileName"),
