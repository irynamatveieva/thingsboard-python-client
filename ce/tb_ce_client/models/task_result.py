...
class TaskResult(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[DummyTaskResult]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[DummyTaskResult]]:
        """Create an instance of TaskResult from a dict"""
        # look up the object type based on discriminator mapping
        object_type = cls.get_discriminator_value(obj)
        if object_type ==  'DummyTaskResult':
            return import_module("tb_ce_client.models.dummy_task_result").DummyTaskResult.from_dict(obj)
