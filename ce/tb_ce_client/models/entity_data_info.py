...
class EntityDataInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["hasRelations", "hasAttributes", "hasCredentials", "hasCalculatedFields"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EntityDataInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EntityDataInfo from a dict"""
        if obj is None:
            return None
