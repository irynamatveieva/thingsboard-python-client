...
class JobConfiguration(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[DummyJobConfiguration]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[DummyJobConfiguration]]:
        """Create an instance of JobConfiguration from a dict"""
        # look up the object type based on discriminator mapping
        object_type = cls.get_discriminator_value(obj)
        if object_type ==  'DummyJobConfiguration':
            return import_module("tb_ce_client.models.dummy_job_configuration").DummyJobConfiguration.from_dict(obj)
