...
class Mapping(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["columns", "delimiter", "update", "header"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "columns": [ColumnMapping.from_dict(_item) for _item in obj["columns"]] if obj.get("columns") is not None else None,
