...
class AlarmCondition(BaseModel):
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[DurationAlarmCondition, RepeatingAlarmCondition, SimpleAlarmCondition]]:
        ...
        if object_type ==  'DurationAlarmCondition':
            return import_module("tb_ce_client.models.duration_alarm_condition").DurationAlarmCondition.from_dict(obj)
        if object_type ==  'RepeatingAlarmCondition':
            return import_module("tb_ce_client.models.repeating_alarm_condition").RepeatingAlarmCondition.from_dict(obj)
        if object_type ==  'SimpleAlarmCondition':
            return import_module("tb_ce_client.models.simple_alarm_condition").SimpleAlarmCondition.from_dict(obj)
