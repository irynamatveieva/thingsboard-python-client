...
class EntityListFilter(EntityFilter):
    ...
    entity_list: Optional[List[StrictStr]] = Field(default=None, alias="entityList")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EntityListFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EntityListFilter from a dict"""
        if obj is None:
            return None
