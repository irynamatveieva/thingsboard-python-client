...
class TbResource(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "createdTime", "tenantId", "title", "resourceType", "resourceSubType", "resourceKey", "publicResourceKey", "etag", "fileName", "descriptor", "data", "preview", "name", "public", "link", "publicLink"]
