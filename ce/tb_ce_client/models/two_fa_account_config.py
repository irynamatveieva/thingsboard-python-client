...
class TwoFaAccountConfig(BaseModel):
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[BackupCodeTwoFaAccountConfig, EmailTwoFaAccountConfig, SmsTwoFaAccountConfig, TotpTwoFaAccountConfig]]:
        ...
        if object_type ==  'BackupCodeTwoFaAccountConfig':
            return import_module("tb_ce_client.models.backup_code_two_fa_account_config").BackupCodeTwoFaAccountConfig.from_dict(obj)
        if object_type ==  'EmailTwoFaAccountConfig':
            return import_module("tb_ce_client.models.email_two_fa_account_config").EmailTwoFaAccountConfig.from_dict(obj)
        if object_type ==  'SmsTwoFaAccountConfig':
            return import_module("tb_ce_client.models.sms_two_fa_account_config").SmsTwoFaAccountConfig.from_dict(obj)
        if object_type ==  'TotpTwoFaAccountConfig':
            return import_module("tb_ce_client.models.totp_two_fa_account_config").TotpTwoFaAccountConfig.from_dict(obj)
