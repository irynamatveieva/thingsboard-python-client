...
class LifeCycleEventFilter(EventFilter):
    ...
    __properties: ClassVar[List[str]] = ["eventType", "notEmpty", "server", "event", "status", "errorStr"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LifeCycleEventFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LifeCycleEventFilter from a dict"""
        if obj is None:
            return None
