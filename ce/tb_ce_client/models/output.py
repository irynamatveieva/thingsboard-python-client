...
class Output(BaseModel):
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[AttributesOutput, TimeSeriesOutput]]:
        ...
        if object_type ==  'AttributesOutput':
            return import_module("tb_ce_client.models.attributes_output").AttributesOutput.from_dict(obj)
        if object_type ==  'TimeSeriesOutput':
            return import_module("tb_ce_client.models.time_series_output").TimeSeriesOutput.from_dict(obj)
