...
class UsersFilter(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[AffectedTenantAdministratorsFilter, AffectedUserFilter, AllUsersFilter, CustomerUsersFilter, OriginatorEntityOwnerUsersFilter, SystemAdministratorsFilter, TenantAdministratorsFilter, UserListFilter]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[AffectedTenantAdministratorsFilter, AffectedUserFilter, AllUsersFilter, CustomerUsersFilter, OriginatorEntityOwnerUsersFilter, SystemAdministratorsFilter, TenantAdministratorsFilter, UserListFilter]]:
        """Create an instance of UsersFilter from a dict"""
        # look up the object type based on discriminator mapping
        object_type = cls.get_discriminator_value(obj)
        if object_type ==  'AffectedTenantAdministratorsFilter':
            return import_module("tb_ce_client.models.affected_tenant_administrators_filter").AffectedTenantAdministratorsFilter.from_dict(obj)
        if object_type ==  'AffectedUserFilter':
            return import_module("tb_ce_client.models.affected_user_filter").AffectedUserFilter.from_dict(obj)
        if object_type ==  'AllUsersFilter':
            return import_module("tb_ce_client.models.all_users_filter").AllUsersFilter.from_dict(obj)
        if object_type ==  'CustomerUsersFilter':
            return import_module("tb_ce_client.models.customer_users_filter").CustomerUsersFilter.from_dict(obj)
        if object_type ==  'OriginatorEntityOwnerUsersFilter':
            return import_module("tb_ce_client.models.originator_entity_owner_users_filter").OriginatorEntityOwnerUsersFilter.from_dict(obj)
        if object_type ==  'SystemAdministratorsFilter':
            return import_module("tb_ce_client.models.system_administrators_filter").SystemAdministratorsFilter.from_dict(obj)
        if object_type ==  'TenantAdministratorsFilter':
            return import_module("tb_ce_client.models.tenant_administrators_filter").TenantAdministratorsFilter.from_dict(obj)
        if object_type ==  'UserListFilter':
            return import_module("tb_ce_client.models.user_list_filter").UserListFilter.from_dict(obj)
