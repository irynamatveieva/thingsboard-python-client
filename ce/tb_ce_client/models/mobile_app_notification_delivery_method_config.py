...
class MobileAppNotificationDeliveryMethodConfig(NotificationDeliveryMethodConfig):
    ...
    firebase_service_account_credentials: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="firebaseServiceAccountCredentials")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MobileAppNotificationDeliveryMethodConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MobileAppNotificationDeliveryMethodConfig from a dict"""
        if obj is None:
            return None
