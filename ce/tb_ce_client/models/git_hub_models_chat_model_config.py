...
class GitHubModelsChatModelConfig(AiModelConfig):
    ...
    provider_config: GitHubModelsProviderConfig = Field(alias="providerConfig")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "providerConfig": GitHubModelsProviderConfig.from_dict(obj["providerConfig"]) if obj.get("providerConfig") is not None else None,
