...
class MobileLayoutConfig(BaseModel):
    ...
    MobileLayoutConfig
    """ # noqa: E501
    pages: Optional[List[MobilePage]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MobileLayoutConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MobileLayoutConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "pages": [MobilePage.from_dict(_item) for _item in obj["pages"]] if obj.get("pages") is not None else None
        })
        return _obj
