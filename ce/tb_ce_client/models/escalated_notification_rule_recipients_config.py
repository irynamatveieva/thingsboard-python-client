...
class EscalatedNotificationRuleRecipientsConfig(NotificationRuleRecipientsConfig):
    ...
    """ # noqa: E501
    escalation_table: Dict[str, List[UUID]] = Field(alias="escalationTable")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EscalatedNotificationRuleRecipientsConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EscalatedNotificationRuleRecipientsConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "escalationTable": obj.get("escalationTable")
        })
        return _obj
