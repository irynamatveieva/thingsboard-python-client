...
class NotificationRuleRecipientsConfig(BaseModel):
    ...
    """ # noqa: E501
    trigger_type: Optional[NotificationRuleTriggerType] = Field(default=None, serialization_alias="triggerType")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[EscalatedNotificationRuleRecipientsConfig, AlarmAssignmentRecipientsConfig, AlarmCommentRecipientsConfig, ApiUsageLimitRecipientsConfig, DeviceActivityRecipientsConfig, EdgeCommunicationFailureRecipientsConfig, EdgeConnectionRecipientsConfig, EntitiesLimitRecipientsConfig, EntityActionRecipientsConfig, NewPlatformVersionRecipientsConfig, RateLimitsRecipientsConfig, ResourceShortageRecipientsConfig, RuleEngineComponentLifecycleEventRecipientsConfig, TaskProcessingFailureRecipientsConfig]]:
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[EscalatedNotificationRuleRecipientsConfig, AlarmAssignmentRecipientsConfig, AlarmCommentRecipientsConfig, ApiUsageLimitRecipientsConfig, DeviceActivityRecipientsConfig, EdgeCommunicationFailureRecipientsConfig, EdgeConnectionRecipientsConfig, EntitiesLimitRecipientsConfig, EntityActionRecipientsConfig, NewPlatformVersionRecipientsConfig, RateLimitsRecipientsConfig, ResourceShortageRecipientsConfig, RuleEngineComponentLifecycleEventRecipientsConfig, TaskProcessingFailureRecipientsConfig]]:
        ...
        if object_type ==  'EscalatedNotificationRuleRecipientsConfig':
            return import_module("tb_ce_client.models.escalated_notification_rule_recipients_config").EscalatedNotificationRuleRecipientsConfig.from_dict(obj)
        if object_type ==  'AlarmAssignmentRecipientsConfig':
            return import_module("tb_ce_client.models.alarm_assignment_recipients_config").AlarmAssignmentRecipientsConfig.from_dict(obj)
        if object_type ==  'AlarmCommentRecipientsConfig':
            return import_module("tb_ce_client.models.alarm_comment_recipients_config").AlarmCommentRecipientsConfig.from_dict(obj)
        if object_type ==  'ApiUsageLimitRecipientsConfig':
            return import_module("tb_ce_client.models.api_usage_limit_recipients_config").ApiUsageLimitRecipientsConfig.from_dict(obj)
        if object_type ==  'DeviceActivityRecipientsConfig':
            return import_module("tb_ce_client.models.device_activity_recipients_config").DeviceActivityRecipientsConfig.from_dict(obj)
        if object_type ==  'EdgeCommunicationFailureRecipientsConfig':
            return import_module("tb_ce_client.models.edge_communication_failure_recipients_config").EdgeCommunicationFailureRecipientsConfig.from_dict(obj)
        if object_type ==  'EdgeConnectionRecipientsConfig':
            return import_module("tb_ce_client.models.edge_connection_recipients_config").EdgeConnectionRecipientsConfig.from_dict(obj)
        if object_type ==  'EntitiesLimitRecipientsConfig':
            return import_module("tb_ce_client.models.entities_limit_recipients_config").EntitiesLimitRecipientsConfig.from_dict(obj)
        if object_type ==  'EntityActionRecipientsConfig':
            return import_module("tb_ce_client.models.entity_action_recipients_config").EntityActionRecipientsConfig.from_dict(obj)
        if object_type ==  'NewPlatformVersionRecipientsConfig':
            return import_module("tb_ce_client.models.new_platform_version_recipients_config").NewPlatformVersionRecipientsConfig.from_dict(obj)
        if object_type ==  'RateLimitsRecipientsConfig':
            return import_module("tb_ce_client.models.rate_limits_recipients_config").RateLimitsRecipientsConfig.from_dict(obj)
        if object_type ==  'ResourceShortageRecipientsConfig':
            return import_module("tb_ce_client.models.resource_shortage_recipients_config").ResourceShortageRecipientsConfig.from_dict(obj)
        if object_type ==  'RuleEngineComponentLifecycleEventRecipientsConfig':
            return import_module("tb_ce_client.models.rule_engine_component_lifecycle_event_recipients_config").RuleEngineComponentLifecycleEventRecipientsConfig.from_dict(obj)
        if object_type ==  'TaskProcessingFailureRecipientsConfig':
            return import_module("tb_ce_client.models.task_processing_failure_recipients_config").TaskProcessingFailureRecipientsConfig.from_dict(obj)
