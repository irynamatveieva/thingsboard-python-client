...
class TbUserMessage(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TbUserMessage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TbUserMessage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "contents": [TbContent.from_dict(_item) for _item in obj["contents"]] if obj.get("contents") is not None else None
        })
        return _obj
