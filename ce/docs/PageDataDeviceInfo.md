...
`tb_ce_client.models.PageDataDeviceInfo`

## Properties

| Name | Type | Description | Notes |
|------------ | ------------- | ------------- | -------------|
| **data** | [**List[DeviceInfo]**](DeviceInfo.md) | Array of the entities | [optional] |
...
| customer_title | str | Title of the Customer that owns the device. | [optional] [readonly] |
...
- **Deserialize:** `PageDataDeviceInfo.model_validate(data)` or `PageDataDeviceInfo.model_validate_json(json_str)`
