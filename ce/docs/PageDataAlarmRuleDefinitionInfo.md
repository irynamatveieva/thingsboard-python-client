...
`tb_ce_client.models.PageDataAlarmRuleDefinitionInfo`

## Properties

| Name | Type | Description | Notes |
|------------ | ------------- | ------------- | -------------|
| **data** | [**List[AlarmRuleDefinitionInfo]**](AlarmRuleDefinitionInfo.md) | Array of the entities | [optional] |
...
- **Deserialize:** `PageDataAlarmRuleDefinitionInfo.model_validate(data)` or `PageDataAlarmRuleDefinitionInfo.model_validate_json(json_str)`
