...
None client.send_entities_limit_increase_request(entity_type: str)  # Send entity limit increase request notification to System administrators (sendEntitiesLimitIncreaseRequest)
```
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **entity_type** | **str** | Entity type | [enum: DEVICE, ASSET, CUSTOMER, USER, DASHBOARD, RULE_CHAIN, EDGE] |
